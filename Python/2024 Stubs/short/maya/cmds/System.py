...
def aaf2fcp(*args, df: bool = ..., dst: Optional[Union[str, bool]] = ..., gfn: Optional[Union[int, bool]] = ..., pr: Optional[Union[int, bool]] = ..., src: Optional[Union[str, bool]] = ..., t: Optional[Union[int, bool]] = ..., wc: Optional[Union[int, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        df: (create) - Delete temporary file. Can only be used with the terminate option
        dst: (create) - Specifiy a destination path
        gfn: (create) - Query output file name
        pr: (create) - Request progress report
        src: (create) - Specifiy a source file
        t: (create) - Complete the task
        wc: (create) - Wait for the conversion process to complete
    """
    ...


def allNodeTypes(*args, ia: bool = ...) -> Any:
    r"""
    ...
    Args:
        ia: (create) - Show every node type, even the abstract ones which cannot be created via the 'createNode' command. These will have the suffix "(abstract)" appended to them in the list.
    """
    ...


def assignInputDevice(*args, c: Optional[Union[str, bool]] = ..., ct: bool = ..., d: Optional[Union[str, bool]] = ..., im: bool = ..., m: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        c: (create) - specify a clutch button.  This button must be down for the command string to be executed. If no clutch is specified the command string is executed everytime the device state changes
        ct: (create) - if this flag is set the command string is continously (once for everytime the device changes state).  By default if a clutch button is specified the command string is only executed once when the button is pressed.
        d: (create) - specify which device to assign the command string.
        im: (create) - Immediately executes the command, without using the queue.
        m: (create) - if this flag is set the other command strings associated with this device are not deleted. By default, when a new command string is attached to the device, all other command strings are deleted.
    """
    ...


def attachDeviceAttr(*args, at: Optional[Union[str, bool]] = ..., ax: Optional[Union[str, bool]] = ..., cam: bool = ..., cr: bool = ..., ct: bool = ..., c: Optional[Union[str, bool]] = ..., d: Optional[Union[str, bool]] = ..., sl: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        at: (create, multiuse) - specify the attribute to attach to
        ax: (create) - specify the axis to attach from.
        cam: (create) - This flag attaches the device/axis to the current camera. The mapping between device axes and camera controls is uses a heuristic based on the device descripton. The interaction is a copy of the mouse camera navigation controls.
        cr: (create) - This flag attaches the device/axis to the current cameras rotation controls.
        ct: (create) - This flag attaches the device/axis to the current cameras translate controls.
        c: (create) - specify a clutch button.  This button must be down for the command string to be executed. If no clutch is specified the command string is executed everytime the device state changes
        d: (create) - specify which device to assign the command string.
        sl: (create) - This flag attaches to the nodes in the selection list. This is different from the default arguments of the command since changing the selection will change the attachments.
    """
    ...


def audioTrack(*args, it: Optional[Union[int, bool]] = ..., l: bool = ..., m: bool = ..., nt: Optional[Union[int, bool]] = ..., ret: bool = ..., rt: Optional[Union[int, bool]] = ..., so: bool = ..., st: Optional[Union[Tuple[int, int], bool]] = ..., t: Optional[Union[str, bool]] = ..., tr: Optional[Union[int, bool]] = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        it: (create) - This flag is used to insert a new empty track at the track index specified. Indices are 1-based.
        l: (create, edit, query) - This flag specifies whether all audio clips on the same track as the specified audio node are to be locked at their current location and track.
        m: (create, edit, query) - This flag specifies whether all audio clips on the same track as the specified audio node are to be muted or not.
        nt: (query) - To query the number of audio tracks
        ...
        so: (create, edit, query) - This flag specifies whether all audio clips on the same track as the specified audio node are to be soloed or not.
        st: (create) - This flag is used to swap the contents of two specified tracks. Indices are 1-based.
        t: (create, edit, query) - This flag specifies the title for the track.
        tr: (create, edit, query) - Specify the track on which to operate by using the track's trackNumber. 			In query mode, this flag needs a value.
    """
    ...


def autoSave(*args, dst: Optional[Union[int, bool]] = ..., df: bool = ..., en: bool = ..., fol: Optional[Union[str, bool]] = ..., int: Optional[Union[float, bool]] = ..., lim: bool = ..., max: Optional[Union[int, bool]] = ..., p: bool = ..., prm: bool = ..., query: bool = ...) -> Any:
    r"""
    Provides an interface to the auto-save mechanism.

    Args:
        dst: (create, query) - Sets the option for where auto-save files go. 0 - auto-saves go into the workspace autosave folder 1 - auto-saves go into the named folder (set with the -folder flag) 2 - auto-saves go into a folder set by an environment variable (MAYA_AUTOSAVE_FOLDER)
        ...
        en: (create, query) - Enables or disables auto-saves.
        fol: (create, query) - Sets the folder for auto-saves used if the destination option is 1.
        int: (create, query) - Sets the interval between auto-saves (in seconds). The default interval is 600 seconds (10 minutes).
        lim: (create, query) - Sets whether the number of auto-save files is limited.
        max: (create, query) - Sets the maximum number of auto-save files, if limiting is in effect.
        p: (create) - Invokes the auto-save process.
        prm: (create, query) - Sets whether the auto-save prompts the user before auto-saving.
    """
    ...


def cacheFile(*args, apf: bool = ..., af: bool = ..., cfn: Optional[Union[str, bool]] = ..., cf: Optional[Union[str, bool]] = ..., ci: Optional[Union[str, bool]] = ..., cat: Optional[Union[str, bool]] = ..., cnd: Optional[Union[str, bool]] = ..., chi: bool = ..., cnm: Optional[Union[str, bool]] = ..., pc2: bool = ..., ccn: bool = ..., cch: Optional[Union[str, bool]] = ..., dsz: bool = ..., dcf: bool = ..., dfn: bool = ..., dir: Optional[Union[str, bool]] = ..., dtf: bool = ..., et: Optional[Union[Union[float, Tuple[float, float]], bool]] = ..., f: Optional[Union[str, bool]] = ..., fm: Optional[Union[str, bool]] = ..., gm: bool = ..., ia: Optional[Union[str, bool]] = ..., it: Optional[Union[str, bool]] = ..., iet: Optional[Union[Union[float, Tuple[float, float]], bool]] = ..., ist: Optional[Union[Union[float, Tuple[float, float]], bool]] = ..., nb: bool = ..., oa: Optional[Union[str, bool]] = ..., ot: Optional[Union[str, bool]] = ..., pcf: Optional[Union[str, bool]] = ..., pc: bool = ..., pts: Optional[Union[str, bool]] = ..., pan: Optional[Union[str, bool]] = ..., p: bool = ..., r: bool = ..., rcf: bool = ..., rws: bool = ..., rf: Optional[Union[int, bool]] = ..., spm: Optional[Union[int, bool]] = ..., smr: Optional[Union[Union[float, Tuple[float, float]], bool]] = ..., sch: bool = ..., st: Optional[Union[Union[float, Tuple[float, float]], bool]] = ..., sc: bool = ..., ws: bool = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        apf: (create) - Appends data to the cache for the times specified by the startTime and endTime flags. If no time is provided, appends the current time. Must be used in conjunction with the pts/points or cnd/cacheableNode flag. Any overwritten frames will not be deleted, but renamed as specified by the f/fileName flag.
        af: (create) - Used to indicate that rather than creating a cache file, that an existing cache file on disk should be attached to an attribute in the scene. The inAttr flag is used to specify the attribute.
        cfn: (create, multiuse) - Specifies the name of the cache file node(s) we are appending/replacing to if more than one cache is attached to the specified geometries. 			In query mode, this flag needs a value.
        cf: (create, query) - Cache file format, default is Maya's .mcx format, but others available via plugin
        ...
        cat: (query) - Returns the list of cacheable attributes defined on the accompanying cache node. This argument requires the use of the cacheableNode flag.
        cnd: (create, multiuse) - Specifies the name of a cacheable node whose contents will be cached. A cacheable node is a node that is specially designed to work with the caching mechanism.  An example of a cacheable node is a nCloth node. 			In query mode, this flag needs a value.
        chi: (create, query) - A query-only flag which returns the channel index for the selected geometry for the cacheFile node specified using the cacheFileNode flag.
        cnm: (create, multiuse, query) - When attachFile is used, used to indicate the channel in the file that should be attached to inAttr.  If not specified, the first channel in the file is used. In query mode, allows user to query the channels associated with a description file.
        pc2: (create) - Convert a PC2 file to the Maya cache format (true), or convert Maya cache to pc2 format (false)
        ccn: (create) - Used to indicate that rather than creating a cache file, that a cacheFile node should be created related to an existing cache file on disk.
        cch: (create, multiuse) - When creating a new cache, this multi-use flag specifies the channels to be cached. The names come from the cacheable channel names defined by the object being cached. If this flag is not used when creating a cache, then all cacheable channels are cached.
        dsz: (query) - This is a query-only flag that returns the size of the data being cached per frame. This flag is to be used in conjunction with the cacheableNode, points, pointsAndNormals and outAttr flags.
        dcf: (create) - Deletes cached data for the times specified by the startTime/endTime flags. If no time is provided, deletes the current frame. Must be used in conjunction with the pts/points or cnd/cacheableNode flag. Deleted frames will not be removed from disk, but renamed as specified by the f/fileName flag.
        dfn: (query) - This is a query-only flag that returns the name of the description file for an existing cacheFile node. Or if no cacheFile node is specified, it returns the description file name that would be created based on the other flags specified.
        dir: (create, query) - Specifies the directory where the cache files will be located. If the directory flag is not specified, the cache files will be placed in the project data directory.
        dtf: (create) - During cache creation, double data is stored in the file as floats.  This helps cut down file size.
        et: (create) - Specifies the end frame of the cache range.
        f: (create, query) - Specifies the base file name for the cache files. If more than one object is being cached and the format is OneFilePerFrame, each cache file will be prefixed with this base file name. In query mode, returns the files associated with the specified cacheFile node. When used with rpf/replaceCachedFrame or apf/appendFrame specifies the name of the backup files. If not specified, replaced frames will be stored with a default name. 			In query mode, this flag can accept a value.
        fm: (create) - Specifies the distribution format of the cache.  Valid values are "OneFile" and "OneFilePerFrame"
        gm: (query) - A query flag which returns the geometry controlled by the specified cache node
        ...
        it: (create) - Specifies the in-tangent type when interpolating frames before the replaced frame(s). Must be used with the ist/interpStartTime and iet/interpEndTime flags. Valid values are "linear", "smooth" and "step".
        iet: (create) - Specifies the frame until which there will be linear interpolation, beginning at endTime. Must be used with the rpf/replaceCachedFrame or apf/appendFrame flag. Interpolation is achieved by removing frames between endTime and interpEndTime from the cache. Removed frames will be renamed as specified by the f/fileName flag.
        ist: (create) - Specifies the frame from which to begin linear interpolation, ending at startTime. Must be used with the rpf/replaceCachedFrame or apf/appendFrame flags. Interpolation is achieved by removing  frames between interpStartTime and startTime from the cache. These removed frames will will be renamed as specified by the f/fileName flag.
        nb: (create) - Specifies that backup files should not be created for any files that may be over-written during append, replace or delete cache frames. Can only be used with the apf/appendFrame, rpf/replaceCachedFrame or dcf/deleteCachedFrame flags.
        oa: (create, multiuse) - Specifies the name of the attribute that will be cached to disk. 			In query mode, this flag needs a value.
        ot: (create) - Specifies the out-tangent type when interpolating frames after the replaced frame(s). Must be used with the ist/interpStartTime and iet/interpEndTime flags. Valid values are "linear", "smooth" and "step".
        pcf: (create) - Specifies the full path to the pc2 file.  Must be used in conjunction with the pc2 flag.
        pc: (query) - A query flag which returns the number of points stored in the cache file. The channelName flag should be used to specify the channel to be queried.
        pts: (create, multiuse) - Specifies the name of a geometry whose points will be cached. 			In query mode, this flag needs a value.
        ...
        p: (create) - Indicates that the specified fileName should be used as a prefix for the cacheName.
        r: (create) - When used during cache creation, forces a screen refresh during caching. This causes the cache creation to be slower but allows you to see how the simulation is progressing during the cache.
        rcf: (create) - Replaces cached data for the times specified by the startTime/endTime flags. If no time is provided, replaces cache file for the current time. Must be used in conjunction with the pts/points or cnd/cacheableNode flag. Replaced frames will not be deleted, but renamed as specified by the f/fileName flag.
        rws: (edit) - When replacing cached frames, this flag specifies whether the replacement should come from the cached node without simulating or from advancing time and letting the simulation run.  This flag is valid only when neither the startTime nor endTime flags are used or when both the startTime and endTime flags specify the same time value.
        rf: (create, edit, query) - Specifies the number of frames of runup to simulate ahead of the starting frame. The value must be greater than or equal to 0.  The default is 2.
        spm: (create, edit, query) - Specifies the sample rate when caches are being created as a multiple of simulation Rate. If the value is 1, then a sample will be cached everytime the time is advanced.  If the value is 2, then every other sample will be cached, and so on.  The default is 1.
        smr: (create, edit, query) - Specifies the simulation rate when caches are being created.  During cache creation, the time will be advanced by the simulation rate, until the end time of the cache is reached or surpassed.  The value is given in frames. The default value is 1 frame.
        sch: (create) - When used in conjunction with the points, pointsAndNormal or cacheableNode flag, specifies whether multiple geometries should be put into a single cache or to create one cache per geometry (default).
        st: (create) - Specifies the start frame of the cache range.
        ...
        ws: (create) - If the points flag is used, turning on this flag will result in the world space positions of the points being written. The expected use of this flag is for cache export.
    """
    ...


def cacheFileCombine(*args, ci: bool = ..., cnm: str = ..., cc: Optional[Union[str, bool]] = ..., kw: bool = ..., ln: bool = ..., na: bool = ..., obj: Optional[Union[str, bool]] = ..., oi: Optional[Union[int, bool]] = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    Creates a cacheBlend node that can be used to combine, layer or blend multiple cacheFiles for a given object.

    Args:
        ci: (query) - A query only flag that returns the index related to the cache specified with the connectCache flag.
        cnm: (edit, multiuse) - Used in conjunction with the connectCache flag to indicate the channel(s) that should be connected.  If not specified, the first channel in the file is used.
        cc: (edit, query) - An edit flag that specifies a cacheFile node that should be connected to the next available index on the specified cacheBlend node. As a query flag, it returns a string array containing the cacheFiles that feed into the specified cacheBlend node. 			In query mode, this flag can accept a value.
        kw: (edit) - This is a flag for use in combination with the connectCache flag only. By default, the connectCache flag will set all weights other than the newly added cacheWeight to 0 so that the new cache gets complete control. This flag disables that behavior so that all existing blend weights are retained.
        ln: (query) - A query flag that returns a string array of the existing cacheBlends on the selected object(s). Returns an empty string array if no cacheBlends are found.
        na: (query) - A query flag that returns the next available index on the selected cacheBlend node.
        obj: (query) - This flag is used in combination with the objectIndex flag. It is used to specify the object whose index you wish to query. 			In query mode, this flag needs a value.
        oi: (edit, query) - In edit mode, used in conjunction with the connectCache flag to indicate the objectIndex to be connected. In query mode, returns the index related to the object specified with the object flag.
    """
    ...


def cacheFileMerge(*args, et: Optional[Union[Union[float, Tuple[float, float]], bool]] = ..., g: bool = ..., st: Optional[Union[Union[float, Tuple[float, float]], bool]] = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        et: (create) - Specifies the end frame of the merge range. If not specified, will figure out range from times of caches being merged.
        g: (query) - Query-only flag used to find the geometry nodes associated with the specified cache files.
        st: (create) - Specifies the start frame of the merge range. If not specified, will figure out range from the times of the caches being merged.
    """
    ...


def cacheFileTrack(*args, it: Optional[Union[int, bool]] = ..., l: bool = ..., m: bool = ..., ret: bool = ..., rt: Optional[Union[int, bool]] = ..., so: bool = ..., t: Optional[Union[int, bool]] = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ...
        l: (create, edit, query) - This flag specifies whether clips on a track are to be locked or not.
        m: (create, edit, query) - This flag specifies whether clips on a track are to be muted or not.
        ret: (create) - This flag is used to remove all tracks that have no clips.
        rt: (create) - This flag is used to remove the track with the specified index.  The track must have no clips on it before it can be removed.
        so: (create, edit, query) - This flag specifies whether clips on a track are to be soloed or not.
        t: (create, edit, query) - Used to specify a new track index for a cache to be displayed. Track-indices are 1-based.
    """
    ...


def clearCache(*args, all: bool = ..., c: bool = ..., d: bool = ...) -> Any:
    r"""
    ...
    Args:
        all: (create) - If toggled then all nodes in the graph are cleared.  Otherwise only those nodes that are selected are cleared.
        c: (create) - If toggled then remove all data that is computable.  (Warning: If the data is requested for redraw then the recompute will immediately fill the data back in.)
        d: (create) - If toggled then remove all heavy data that is dirty.
    """
    ...


def cmdFileOutput(*args, c: Optional[Union[int, bool]] = ..., ca: bool = ..., o: Optional[Union[str, bool]] = ..., s: Optional[Union[int, bool]] = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        c: (create) - Closes the file corresponding to the given descriptor. If -3 is returned, the file did not exist. -1 is returned on error, 0 is returned on successful close.
        ca: (create) - Closes all open files.
        o: (create, query) - Opens the given file for writing (will overwrite if it exists and is writable). If successful, a value is returned to enable status queries and file close. -1 is returned if the file cannot be opened for writing. The -open flag can also be specified in -query mode. In query mode, if the named file is currently opened, the descriptor for the specified file is returned, otherwise -1 is returned. This is an easy way to check if a given file is currently open.       In query mode, this flag needs a value.
        s: (create, query) - Queries the status of the given descriptor. -3 is returned if no such file exists, -2 indicates the file is not open, -1 indicates an error condition, 0 indicates file is ready for writing.
    """
    ...


def convertUnit(*args, f: Optional[Union[str, bool]] = ..., t: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        f: (create) - The unit to convert from.  If not supplied, it is assumed to be the system default.  The from unit may also be supplied as part of the value e.g. 11.2m (11.2 meters).
        t: (create) - The unit to convert to.  If not supplied, it is assumed to be the system default
    """
    ...


def crashInfo(*args, cf: bool = ..., cl: bool = ..., sbc: bool = ..., query: bool = ...) -> Any:
    r"""
    Provides an interface to the crash file information.

    Args:
        cf: (query) - Return the crash file full path name.
        cl: (query) - Return the crash log full path name.
        sbc: (query) - Return the saved file full path name before crash.
    """
    ...


def dagObjectCompare(*args, a: bool = ..., b: Optional[Union[str, bool]] = ..., c: bool = ..., n: Optional[Union[str, bool]] = ..., r: bool = ..., s: bool = ..., t: bool = ...) -> Any:
    r"""
    ...
    Args:
        a: (create) - Compare dag object attributes
        b: (create) - Bail on first error or bail on category. Legal values are "never", "first", and "category".
        c: (create) - Compare dag connections
        n: (create) - The baseline namespace
        r: (create) - dag relatives
        s: (create) - Compress output to short form (not as verbose)
        t: (create) - Compare based on dag object type
    """
    ...


def date(*args, d: bool = ..., f: Optional[Union[str, bool]] = ..., sd: bool = ..., st: bool = ..., t: bool = ...) -> Any:
    r"""
    ...
    Args:
        d: (create) - Returns the current date. Format is YYYY/MM/DD
        ...
        sd: (create) - Returns the current date. Format is MM/DD
        st: (create) - Returns the current time. Format is hh:mm
        t: (create) - Returns the current time. Format is hh:mm:ss
    """
    ...


def dbcount(*args, e: bool = ..., f: Optional[Union[str, bool]] = ..., k: Optional[Union[str, bool]] = ..., l: bool = ..., md: Optional[Union[int, bool]] = ..., q: bool = ..., r: bool = ..., s: bool = ...) -> Any:
    r"""
    ...
    Args:
        e: (create) - Set the enabled state of the counters ('on' to enable, 'off' to disable). Returns the list of all counters affected.
        f: (create) - Destination file of the enabled count objects.  Use the special names stdout and stderr to redirect to your command window.  As well, the special name msdev is available on NT to direct your output to the debug tab in the output window of Developer Studio.
        k: (create) - Print only the counters whose name matches this keyword (default is all).
        l: (create) - List all available counters and their current enabled status. (The only thing you can do when counters are disabled.)
        md: (create) - Maximum number of levels down to traverse and report. 0 is the default and it means continue recursing as many times as are requested.
        q: (create) - Display only a summary for each counter type instead of the full details.
        r: (create) - Reset all counters back to 0 and remove all but the top level counters. Returns the list of all counters affected.
        s: (create) - Display in spreadsheet format instead of the usual nested braces. This will include a header row that contains 'Count Level1 Level2 Level3...', making the data suitable for opening directly in a spreadsheet table.
    """
    ...


def dbfootprint(*args, all: bool = ..., of: Optional[Union[str, bool]] = ..., t: Optional[Union[str, bool]] = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ...
        of: (create) - Specify the location of a file to which the information is to be dumped. Default will return the value from the command.  Use the special names stdout, cout, stderr, or cerr to redirect to the standard output or error locations.
...
def dbmessage(*args, f: Optional[Union[str, bool]] = ..., l: bool = ..., m: bool = ..., t: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        f: (create) - Destination file of the message monitoring information.  Use the special names stdout and stderr to redirect to your command window.  As well, the special name msdev is available on NT to direct your output to the debug tab in the output window of Developer Studio. Default value is stdout.
        l: (create) - List all available message types and their current enabled status.
        m: (create) - Set the monitoring state of the message type ('on' to enable, 'off' to disable). Returns the list of all message types being monitored after the change in state.
        t: (create) - Monitor only the messages whose name matches this keyword (default is all).
    """
    ...


def dbpeek(*args, all: bool = ..., a: Optional[Union[str, bool]] = ..., c: Optional[Union[int, bool]] = ..., eg: bool = ..., op: Optional[Union[str, bool]] = ..., of: Optional[Union[str, bool]] = ..., query: bool = ...) -> Any:
    r"""
...
def dbtrace(*args, f: Optional[Union[str, bool]] = ..., i: bool = ..., k: Optional[Union[str, bool]] = ..., m: bool = ..., o: Optional[Union[str, bool]] = ..., tm: bool = ..., t: Optional[Union[str, bool]] = ..., v: bool = ..., query: bool = ...) -> Any:
    ...
    Args:
        f: (create, query) - Set the filter object for these trace objects (see 'dgfilter')
        i: (query) - In query mode return a brief description of the trace object.
        k: (create, multiuse, query) - Keyword of the trace objects to affect 			In query mode, this flag can accept a value.
        m: (create) - Display a mark for all outputs of defined trace objects
        : (create) - Toggle the traces off.  If omitted it will turn them on.
        o: (create, query) - Destination file of the affected trace objects.  Use the special names stdout and stderr to redirect to your command window. The special name msdev is available on Windows to direct your output to the debug tab in the output window of Visual Studio.
        tm: (create, query) - Turn on/off timing information in the output of the specified trace objects.
        t: (create) - Display a title mark for all outputs of defined trace objects
        v: (create) - Include all traces in output and filter queries, not just those turned on.
    """
    ...


def detachDeviceAttr(*args, all: bool = ..., at: Optional[Union[str, bool]] = ..., ax: Optional[Union[str, bool]] = ..., d: Optional[Union[str, bool]] = ..., sl: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ...
        at: (create) - The attribute to detach. This flag must be used with the -d/device flag.
        ax: (create) - The axis to detach. This flag must be used with the -d/device flag.
        d: (create) - Delete the attachment for this device. If the -ax/axis flag is not used, all of the attachments connected to this device are detached.
        sl: (create) - Detaches selection attachments.
    """
    ...


def deviceEditor(*args, ctl: bool = ..., dt: Optional[Union[str, bool]] = ..., dtg: Optional[Union[str, bool]] = ..., ex: bool = ..., f: Optional[Union[str, bool]] = ..., fmc: Optional[Union[str, bool]] = ..., hlc: Optional[Union[str, bool]] = ..., lck: bool = ..., mlc: Optional[Union[str, bool]] = ..., pnl: Optional[Union[str, bool]] = ..., p: Optional[Union[str, bool]] = ..., slc: Optional[Union[str, bool]] = ..., sts: bool = ..., tp: Optional[Union[str, bool]] = ..., up: bool = ..., ulk: bool = ..., upd: bool = ..., ut: Optional[Union[str, bool]] = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ...
        tp: (edit, query) - The path used for writing/reading take data through the editor.
...
def devicePanel(*args, ctl: bool = ..., cp: str = ..., cs: bool = ..., dt: Optional[Union[str, bool]] = ..., dtg: Optional[Union[str, bool]] = ..., es: bool = ..., ex: bool = ..., init: bool = ..., iu: bool = ..., l: Optional[Union[str, bool]] = ..., mrl: bool = ..., mbv: bool = ..., ni: bool = ..., p: Optional[Union[str, bool]] = ..., pmp: Optional[Union[str, bool]] = ..., rp: str = ..., to: bool = ..., toc: Optional[Union[str, bool]] = ..., tor: bool = ..., up: bool = ..., ut: Optional[Union[str, bool]] = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
...
def dgdirty(*args, a: bool = ..., c: bool = ..., i: bool = ..., l: Optional[Union[str, bool]] = ..., p: bool = ..., st: bool = ..., v: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        a: (create, query) - Ignore the selected or specified objects and dirty (or clean) all plugs.
        c: (create, query) - If this flag is set then the attributes are cleaned.  Otherwise they are set to dirty.
        i: (create, query) - If this flag is set then allow the implicit or default nodes to be processed as well. Otherwise they will be skipped for efficiency.
        l: (create, query) - When this flag is specified then instead of sending out dirty/clean messages the list of currently dirty/clean objects will be returned. The allPlugs and clean flags are respected to narrow guide the values to be returned. The value of the flag tells what will be reported.  "data" or "d" = show plugs that have dirty/clean data "plug" or "p" = show plugs that have dirty/clean states "connection" or "c" = show plugs with connections that have dirty/clean states Query this flag to find all legal values of the flag. Query this flag with its value already set to get a description of what that value means.  Note that "p" and "c" modes are restricted to plugs that have connections or non-standard state information. Other attributes will not have state information to check, though they will have data. In the case of array attributes only the children that have values currently set will be considered. No attempt will be made to evaluate them in order to update the available child lists. e.g. if you have a DAG with transform T1 and shape S1 the instanced attribute S1.wm[0] will be reported. If in a script you create a second instance T2->S1 and immediately list the plugs again before evaluation you will still only see S1.wm[0]. The new S1.wm[1] won't be reported until it is created through an evaluation, usually caused by refresh, a specific getAttr command, or an editor update. Note that the list is only for selected nodes. Unlike when dirty messages are sent this does not travel downstream.
        p: (create, query) - If this flag is set then the ability of dirty messages to flow through the graph is left enabled.
        st: (create, query) - If this flag is used then show how long the dirty messages took to propagate.
        v: (create, query) - Prints out all of the plugs being set dirty on stdout.
    """
    ...


def dgeval(*args, src: bool = ..., v: bool = ...) -> Any:
    r"""
    ...
    Args:
        ...
        v: (create) - If this flag is used then the results of the evaluation(s) is/are printed on stdout.
    """
    ...


def dgfilter(*args, atr: Optional[Union[str, bool]] = ..., l: bool = ..., logicalAnd: Optional[Union[Tuple[str, str], bool]] = ..., logicalNot: Optional[Union[str, bool]] = ..., logicalOr: Optional[Union[Tuple[str, str], bool]] = ..., n: Optional[Union[str, bool]] = ..., nd: Optional[Union[str, bool]] = ..., nt: Optional[Union[str, bool]] = ..., p: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        atr: (create) - Select objects whose attribute names match the pattern.
        l: (create) - List the available filters.  If used in conjunction with the -name flag it will show a description of what the filter is.
        ...
        n: (create) - Use filter named FILTER (or create new filter with that name). If no objects are specified then the name given to the filter will be returned.
        nd: (create) - Select objects whose node names match the pattern.
        nt: (create) - Select objects whose node type names match the pattern.
        p: (create) - Select objects whose plug names match the pattern.
    """
    ...


def dgInfo(*args, all: bool = ..., c: bool = ..., d: bool = ..., n: bool = ..., nd: bool = ..., of: Optional[Union[str, bool]] = ..., p: bool = ..., s: bool = ..., sz: bool = ..., sub: bool = ..., nt: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        all: (create) - Use the entire graph as the context
        c: (create) - Print the connection information
        d: (create) - Only print dirty/clean nodes/plugs/connections.  Default is both
        n: (create) - Print the specified nodes (or the entire graph if -all is used)
        nd: (create) - Include non-deletable nodes as well (normally not of interest)
        of: (create) - Send the output to the file FILE instead of STDERR
        p: (create) - Only print propagating/not propagating nodes/plugs/connections. Default is both.
        s: (create) - Print using short format instead of long
        sz: (create) - Show datablock sizes for all specified nodes. Return value is tuple of all selected nodes (NumberOfNodes, NumberOfDatablocks, TotalDatablockMemory)
        sub: (create) - Print the subgraph affected by the node or plugs (or all nodes in the graph grouped in subgraphs if -all is used)
        nt: (create) - Filter output to only show nodes of type NODETYPE
    """
    ...
...
def dgtimer(*args, ct: bool = ..., hi: Optional[Union[str, bool]] = ..., h: bool = ..., m: Optional[Union[int, bool]] = ..., n: Optional[Union[str, bool]] = ..., nh: bool = ..., o: Optional[Union[str, bool]] = ..., oh: bool = ..., rgl: Optional[Union[float, bool]] = ..., rgu: Optional[Union[float, bool]] = ..., r: bool = ..., rc: Optional[Union[str, bool]] = ..., rt: Optional[Union[str, bool]] = ..., sh: Optional[Union[str, bool]] = ..., sm: Optional[Union[str, bool]] = ..., st: Optional[Union[str, bool]] = ..., th: Optional[Union[float, bool]] = ..., off: bool = ..., on: bool = ..., tr: bool = ..., t: Optional[Union[str, bool]] = ..., un: bool = ..., uhm: Optional[Union[int, bool]] = ..., query: bool = ...) -> Any:
    r"""
...
def dgValidateCurve(*args, a: bool = ..., v: bool = ...) -> Any:
    ...
    Args:
        a: (create) - Ignore the selected or specified objects and work on all curves.
        v: (create) - Prints out all of the curves set static or not.
    """
    ...


def dirmap(*args, cd: Optional[Union[str, bool]] = ..., en: bool = ..., gam: bool = ..., gmd: Optional[Union[str, bool]] = ..., m: Optional[Union[Tuple[str, str], bool]] = ..., um: Optional[Union[str, bool]] = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        cd: (create) - Convert a file or directory. Returns the name of the mapped file or directory, if the command is enabled. If the given string contains one of the mapped directories, the return value will have that substring replaced with the mapped one. Otherwise the given argument string will be returned. If the command is disabled the given argument is always returned. Checks are not made for whether the file or directory exists. If the given string is a directory it should have a trailing '/'.
        en: (create, query) - Enable directory mapping. Directory mapping is off when you start Maya. If enabled, when opening Maya scenes, file texture paths (and other file paths) will be converted when the scene is opened. The -cd flag only returns mapped directories when -enable is true. Query returns whether mapping has been enabled.
        gam: (create) - Get all current mappings. Returns string array of current mappings in format: [redirect1, replacement1, ... redirectN, replacementN]
        gmd: (create) - Get the mapped redirected directory. The given argument must exactly match the first string used with the -mapDirectory flag.
        m: (create) - Map a directory - the first argument is mapped to the second. Neither directory needs to exist on the local machine at the time of invocation.
        um: (create) - Unmap a directory. The given argument must exactly match the argument used with the -mapDirectory flag.
    """
    ...


def diskCache(*args, a: bool = ..., ct: Optional[Union[str, bool]] = ..., c: Optional[Union[str, bool]] = ..., ca: bool = ..., d: Optional[Union[str, bool]] = ..., da: bool = ..., e: Optional[Union[str, bool]] = ..., ea: bool = ..., eco: bool = ..., et: Optional[Union[Union[float, Tuple[float, float]], bool]] = ..., frt: Optional[Union[str, bool]] = ..., os: bool = ..., sr: Optional[Union[int, bool]] = ..., st: Optional[Union[Union[float, Tuple[float, float]], bool]] = ..., tmp: bool = ..., query: bool = ...) -> Any:
    r"""
    Command to create, clear, or close disk cache(s).

    Args:
        a: (create, query) - Append at the end and not to flush the existing cache
        ct: (create, query) - Specifies the type of cache to overwrite.  "mcfp" for particle playback cache, "mcfi" for particle initial cache. "mcj" for jiggle cache. This option is only activated during the cache creation.
        c: (create, query) - Close the cache given the disk cache node name.  If -eco/enabledCachesOnly is "true" only enabled disk cache nodes are affected.
        ca: (create, query) - Close all disk cache files. If -eco/enabledCachesOnly is "true" only enabled disk cache nodes are affected.
        d: (create, query) - Delete the cache given the disk cache node name.  If -eco/enabledCachesOnly is "true" only enabled disk cache nodes are affected.
        da: (create, query) - Delete all disk cache files.  If -eco/enabledCachesOnly is "true" only enabled disk cache nodes are affected.
        e: (create, query) - Clear the content of the disk cache with the given disk cache node name.  If -eco/enabledCachesOnly is "true" only enabled disk cache nodes are affected.
        ea: (create, query) - Clear the content of all disk caches.  If -eco/enabledCachesOnly is "true" only enabled disk cache nodes are affected.
        eco: (create, query) - When present, this flag restricts the -ea/emptyAll, so that only "enabled" disk caches (i.e., disk cache nodes with the ".enable" attribute set to "true") are affected.
        et: (create, query) - Specifies the end frame of the cache range.
        frt: (create, query) - Specifies the type of frame range to use, namely "Render Globals", "Time Slider", and "Start/End".  In the case of "Time Slider", startFrame and endFrame need to be specified.  (This flag is now obsolete.  Please use the -startTime and -endTime flags to specify the frame range explicitly.)
        os: (create, query) - Over sample if true. Otherwise, under sample.
        sr: (create, query) - Specifies how frequently to sample relative to each frame. When over-sampling (-overSample has been specified), this parameter determines how many times per frame the runup will be evaluated. When under-sampling (the default, when -overSample has not been specified), the runup will evaluate only once per sr frames, where sr is the value specified to this flag.
        st: (create, query) - Specifies the start frame of the cache range.
        tmp: (create, query) - Query-only flag for the location of temporary diskCache files.
    """
    ...


def displayString(*args, d: bool = ..., ex: bool = ..., k: bool = ..., r: bool = ..., v: Optional[Union[str, bool]] = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        d: (create) - This flag is used to remove an identifer string. The command will fail if the identifier does not exist.
        ex: (create) - Returns true or false depending upon whether the specified identifier exists.
        k: (create, query) - List all displayString keys that match the identifier string. The identifier string may be a whole or partial key string. The command will return a list of all identifier keys that contain this identifier string as a substring.
        r: (create, query) - Since a displayString command will fail if it tries to assign a new value to an existing identifer, this flag is required to allow updates to the value of an already-existing identifier.  If the identifier does not already exist, a new identifier is added as if the -replace flag were not present.
        v: (create, query) - The display string\'s value. If you do not specify this flag when creating a display string then the value will be the same as the identifier.
    """
    ...
...
def error(*args, n: bool = ..., sl: bool = ...) -> Any:
    r"""
    ...
    Args:
        n: (create) - Do not include the context information with the error message.
        sl: (create) - Obsolete. Will be deleted in the next version of Maya. Use the checkbox in the script editor that enables line number display instead.
    """
    ...


def exportEdits(*args, ehr: bool = ..., en: Optional[Union[str, bool]] = ..., exs: bool = ..., f: bool = ..., ian: bool = ..., ic: bool = ..., idf: bool = ..., inw: bool = ..., includeNode: Optional[Union[str, bool]] = ..., isa: bool = ..., sdk: bool = ..., ish: bool = ..., sel: bool = ..., typ: Optional[Union[str, bool]] = ..., ec: Optional[Union[str, bool]] = ..., orn: Optional[Union[str, bool]] = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ehr: (create, query) - By default, all DAG parents and DAG history are written to the export file. To prevent any DAG relations not otherwise connected to the target nodes to be included, specify the -excludeHierarchy flag.
        ...
        exs: (create, query) - The selected nodes and their connections to each other will be exported. Additionally, any dangling connections to non-exported nodes will be exported. Default nodes are ignored and never exported. Note that when using the exportSelected flag, only selected nodes are exported, and -include/-exclude flags such as -includeHierarchy are ignored.
        f: (create, query) - Force the export action to take place. This flag is required to overwrite an existing file.
        ian: (create, query) - Additionally include animation nodes and animation helper nodes associated with the target nodes being exported.
        ic: (create, query) - Additionally include constraint-related nodes associated with the target nodes being exported.
        idf: (create, query) - Additionally include deformer networks associated with the target nodes being exported.
        inw: (create, query) - Additionally include the network of nodes connected to the target nodes being exported.
        ...
        isa: (create, query) - When using the -selected/-sel flag, if any of the selected nodes are referenced, also include/exclude any setAttr edits on those nodes. If used with the -onReferenceNode/-orn flag, include/exclude any setAttr edits on the reference.
        sdk: (create, query) - Additionally include setDrivenKey-related nodes associated with the target nodes being exported.
        ish: (create, query) - Additionally include shaders associated with the target nodes being exported.
        sel: (create, query) - Export will operate on the list of nodes currently selected. This flag differs from the exportSelected flag in that the selected nodes are not exported, only the edits on them, and any nodes found via the include flags that are used (such as includeAnimation, includeNetwork and so on).
        typ: (create, query) - Set the type of the exported file. Valid values are "editMA" or "editMB". Note that this command respects the global "defaultExtensions" setting for file naming that is controlled with the file command defaultExtensions option.  See the file command for more information.
        ...
        orn: (create, multiuse, query) - This is a secondary flag used to indicate that only those edits which are stored on the indicated reference node should be considered. This flag only supports multiple uses when specified with the "exportEdits" command.
    """
    ...
...
def file(*args, an: bool = ..., a: bool = ..., ap: bool = ..., add: bool = ..., amf: bool = ..., at: Optional[Union[str, bool]] = ..., bls: bool = ..., chn: bool = ..., cr: Optional[Union[str, bool]] = ..., c: Optional[Union[Tuple[str, str], bool]] = ..., cmp: bool = ..., con: bool = ..., ch: bool = ..., cnl: bool = ..., de: bool = ..., dns: bool = ..., dr: bool = ..., ec: Optional[Union[str, bool]] = ..., err: bool = ..., esn: bool = ..., ex: bool = ..., exn: bool = ..., ea: bool = ..., ean: bool = ..., ear: bool = ..., er: bool = ..., exs: bool = ..., es: bool = ..., eas: bool = ..., esa: bool = ..., esr: bool = ..., ess: bool = ..., esc: Optional[Union[Tuple[str, str], bool]] = ..., eur: bool = ..., exp: bool = ..., fmd: bool = ..., fr: Optional[Union[str, bool]] = ..., f: bool = ..., gl: bool = ..., gn: Optional[Union[str, bool]] = ..., gr: bool = ..., iv: bool = ..., i: bool = ..., ifr: bool = ..., ir: bool = ..., itr: Optional[Union[str, bool]] = ..., lfo: bool = ..., ltf: bool = ..., l: bool = ..., lad: bool = ..., lar: bool = ..., lnr: bool = ..., lr: Optional[Union[str, bool]] = ..., lrd: Optional[Union[str, bool]] = ..., lrp: Optional[Union[str, bool]] = ..., ls: Optional[Union[str, bool]] = ..., loc: bool = ..., lcu: bool = ..., lf: bool = ..., lck: bool = ..., mns: Optional[Union[Tuple[str, str], bool]] = ..., mbl: bool = ..., mnp: bool = ..., mnr: bool = ..., mnc: bool = ..., mf: bool = ..., ms: bool = ..., ns: str = ..., new: bool = ..., o: bool = ..., op: Optional[Union[str, bool]] = ..., pns: bool = ..., pos: Optional[Union[str, bool]] = ..., prs: Optional[Union[str, bool]] = ..., pn: bool = ..., pr: bool = ..., pv: bool = ..., pmt: bool = ..., pm: Optional[Union[str, bool]] = ..., pt: Optional[Union[str, bool]] = ..., r: bool = ..., rdi: Optional[Union[int, bool]] = ..., rfn: Optional[Union[str, bool]] = ..., rns: Optional[Union[str, bool]] = ..., rdn: bool = ..., rr: bool = ..., rn: Optional[Union[str, bool]] = ..., ra: bool = ..., rts: bool = ..., rpr: Optional[Union[str, bool]] = ..., rpl: bool = ..., rep: Optional[Union[Tuple[str, str], bool]] = ..., rvn: bool = ..., rer: bool = ..., rnn: bool = ..., s: bool = ..., sdc: Optional[Union[str, bool]] = ..., sr: bool = ..., sru: bool = ..., stx: Optional[Union[str, bool]] = ..., sn: bool = ..., seg: str = ..., sa: bool = ..., sh: bool = ..., shd: Optional[Union[str, bool]] = ..., srf: bool = ..., shn: bool = ..., str: bool = ..., sns: Optional[Union[Tuple[str, str], bool]] = ..., typ: Optional[Union[str, bool]] = ..., uc: bool = ..., ulc: bool = ..., ur: Optional[Union[str, bool]] = ..., un: bool = ..., uns: bool = ..., wcn: bool = ..., w: bool = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ...
        amf: (query) - This flag is obsolete. Please use file -q -modified instead.
        at: (create) - When importing or referencing an offline edit file, apply it to to the given reference (i.e., determine what <main> gets mapped to). Specify the reference node name as argument. To apply the edits to nodes in the main scene (i.e., the root namespace), pass in ":". To collapse <main> (i.e., map it to "None"), pass in "". May only be used with the file -i/import or -r/reference flags.
        bls: (create) - When used with the "o/open" flag it indicates that the specified file should be read for reference hierarchy information only. This information will be stored in temporary load settings under the name "implicitLoadSettings". When this flag is used the specified scene file will not be loaded: no objects/nodes will be created or modified. Note: most users will not need to use this flag or the "implicitLoadSettings" it builds. They can access the same functionality by setting the "Selective Load" option in the File > Open Option Box.
        chn: (create, query) - For use with exportSelected to specify whether attached channels should be included in the export.
        cr: (create) - Remove edits from the passed in reference node. The reference must be in an unloaded state. To remove a particular type of edit, use the editCommand flag. If no flag is specified, all edits will be removed.
        c: (create, query) - Specifies the callback to execute before any file operation. This is an internal flag used only in the file format.
        cmp: (create) - When used with save, it will compress (gzip) the file on output.
        con: (create, query) - For use with exportSelected to specify whether attached constraints should be included in the export.
        ch: (create, query) - For use with exportSelected to specify whether attached construction history should be included in the export.
        cnl: (query) - When queried, this flag returns a string array containing a number that uniquely identifies each instance the file is used.
        de: (create, query) - Use the default extensions to rename the files. This defaults to true, but is a persistent setting within a given session of Maya, meaning that if you set it to true or false, that value will continue to be used in subsequent file commands until a new value is set.
        dns: (create) - Use the default name space for import and referencing.  This is an advanced option.  If set, then on import or reference, Maya will attempt to place all nodes from the imported or referenced file directly into the root (default) name space, without invoking any name clash resolution algorithms.  If the names of any of the new objects    already exist in the root namespace, then errors will result. The user of this flag is responsible for creating a name clash resolution mechanism outside of Maya to avoid such errors. Note: This flag    is intended only for use with custom file translators written through    the API. Use at your own risk.
        ...
        ec: (create) - For use with cleanReference. Remove only this type of edit. Supported edits are: setAttr addAttr deleteAttr connectAttr disconnectAttr and parent
        err: (query) - Query the error status of the last file read. Returns true if and error occurred during the last file read.
        esn: (create) - If true, allow the appropriate script nodes to execute. If false, do not allow any script node scripts to run. For more information, see the documentation for script nodes. Default: true.
        ex: (query) - Query if the file exists. Returns true if the file exists.
        exn: (query) - This is a query only flag that can be used to query for the file path name of the file.
        ea: (create) - Export everything into a single file. Returns the name of the exported file.
        ...
        ear: (create) - Export the main scene animation nodes and animation helper nodes from all referenced objects. This flag, when used in conjunction with the -rfn/referenceNode flag, can be constrained to only export animation nodes from the specified reference file. See -ean/exportAnim flag description for details on usage of animation files.
        er: (create) - Export the selected objects into a reference file with the given name. The file is saved on disk during the process. Returns the name of the reference created.
        exs: () - This flag is obsolete.
        es: (create) - Export the selected items into the specified file. Returns the name of the exported file.
        eas: (create) - Export all animation nodes and animation helper nodes from the selected objects in the scene. See -ean/exportAnim flag description for details on usage of animation files.
        ...
        gl: (create) - Used only with the -r and the -gr flag. Used to group the output of groupReference under a locator
        gn: (create) - Used only with the -gr flag. Optionally used to set the name of the transform node that the imported/referenced items will be grouped under.
        gr: (create) - Used only with the -r or the -i flag. Used to group all the imported/referenced items under a single transform.
        iv: (create) - Used to open files with versions other than those officially supported. Success is not guaranteed. Data loss, data corruption or failure to open are all possible outcomes. Can only be used with the -o and -i flags.
        i: (create) - Import the specified file. Returns the name of the imported file.
        ifr: (create) - Used only with the -i flag. Used to import the frame rate and set it as Maya's frame rate.
        ir: (create) - Remove the encapsulation of the reference around the data within the specified file.    This makes the contents of the specified file part of the current scene and all references to the original file are lost. Returns the name of the reference that was imported.
        itr: (create) - Used only with the -i flag. Used to import the time range and apply it to Maya's playback range in one of three different ways as specified by the string.  The valid strings are "keep", which keeps Maya's playback range untouched, "override", which overrides Maya's playback range with the imported range, and "combine", which extends Maya's playback range to encompass the imported range.
        lfo: (query) - On query, returns the last option string used by the file command.
        ltf: (query) - When queried, this flag returns the temp file name used during file save. The temp file will be left in the same directory as the intended file name if the save fails.
        l: (query) - List all files. Returns a string array of the names of all segment/reference files. Duplicates will be removed. So if a file is referenced more than once, and the -withoutCopyNumber flag is set, it will only be listed once. in the scene.
        lad: (create) - This flag is obsolete, and has been replaced by the loadReferenceDepth flag. When used with the -open flag, determines if the -deferReference flag is respected when reading in the file. If true is passed, all of the references are loaded. If false is passed, the -deferReference flag is respected.
        lar: (create) - This flag is obsolete and has been replaced with the loadReferenceDepth flag. When used with the -open flag, this will cause all references to be loaded.
        lnr: (create) - This flag is obsolete and has been replaced witht the loadReferenceDepth flag. When used with the -open flag, no references will be loaded. When used with -i/import, -r/reference or -lr/loadReference flags, will load the top-most reference only.
        lr: (create, query) - This flag loads a file and associates it with the passed reference node. If the reference node does not exist, the command will fail. If the file is already loaded, then this flag will reload the same file. If a file is not given, the command will load (or reload) the last used reference file.
        lrd: (create) - Used to specify which references should be loaded. Valid types are "all", "none" and "topOnly", which will load all references, no references and top-level references only, respectively. May only be used with the -o/open, -i/import, -r/reference or -lr/loadReference flags. When "none" is used with -lr/loadReference, only path validation is performed. This can be used to replace a reference without triggering reload. Not using loadReferenceDepth will load references in the same loaded or unloaded state that they were in when the file was saved. Additionally, the -lr/loadReference flag supports a fourth type, "asPrefs". This will force any nested references to be loaded according to the state (if any) stored in the current scene file, rather than according to the state saved in the reference file itself.
        lrp: (create) - This flag will perform a special preview-only load of a reference file. A preview-only reference file is not completely loaded, but instead is partially loaded so that certain information, such as nested references it contains, can be determined. Nested references that are previewed remain in a special preview-only state.
        ...
        loc: (query) - Query the location of the given file name.
        lcu: (create) - Set the unpublised lock state for all containers in this file. This will not lock the attributes in the main scene directly, but any file that references this scene will have all its containers come in as unpublished locked.
        lf: (create) - Lock or unlock the main scene. Any file referencing this scene will automatically lock all attributes and nodes. Also prevents reference edits from being saved to it from a parent file.
        lck: (create) - Locks attributes and nodes from the referenced file.
        mns: (create, edit, multiuse, query) - Map a placeHolderNamespace to the given reference. Must be used with the file -i/import, -r/reference flags in create mode. The first string is the place holder namespace, including the angle brackets (ex: "<foo>"). The second string is the reference node whose namespace it should be mapped to (ex: "refRN"). If the namespace should be mapped to the root namespace, use ":". To collapse the namespace (i.e., map it to "None"), use "". When queried, namespaces that are mapped to "None" will return "(None)" for clarity.
        mbl: (create) - When set, Maya will merge the base animation layer imported from the file with the base layer already existing in the scene.
        mnp: (create) - Used with the removeReference flag. When removing a file reference and its namespace, move the rest of the namespace content to parent namespace. Cannot be used if the reference resides in the root namespace.
        mnr: (create) - Used with the removeReference flag. When removing a file reference and its namespace, move the rest of the namespace content to root namespace. Cannot be used if the reference resides in the root namespace.
        mnc: (create) - Used with the import, reference or edit flags, this option will prevent new namespaces from being created when namespaces of the same name already exist within Maya. The default value is false. For example, if an object "pSphere1", which is being imported, refers to the namespace "ref" and there is already a namespace called "ref" defined in Maya. If mergeNamespacesOnClash is true, the existing "ref" namespace will be reused and pSphere1 will be moved into the existing namespace; and if the namespace has another object which is also named "pSphere1", then the imported one will be renamed with an incremental number("pSphere2"). On the other hand, if mergeNamespacesOnClash is false, a new namespace will be created with an incremental number (in first case is "ref1") and pSphere1 will be moved into the "ref1" namespace. This flag also support nested namespace, for example, if an object "pSphere1" which is imported and refers to namespace "ref:foo" and mergeNamespacesOnClash is true this time, then the existing "ref:foo" will be reused and the object will be moved into "ref:foo". Also if mergeNamespacesOnClash is false, then a new namespace "ref:foo1" will be created and "pSphere1" will be moved into that new namespace.
        mf: (create, query) - Set the modified state of the entire scene. If the scene is modified it will need to be saved before a new file is opened or created. Normally there is no need to edit this flag as the state of the file is updated automatically whenever an object is created or modified. If editing of the state is desired, it is done without use of the edit flag as covered in the example section below. In query mode, if the scene has been modified 1 is returned. Otherwise 0 is returned.
        ms: (edit) - This flag is obsolete.
        ns: (edit) - The namespace name to use that will group all objects during importing and referencing. Change the namespace used to group all the objects from the specified referenced file. The reference must have been created with the "Using Namespaces" option, and must be loaded. Non-referenced nodes contained in the existing namespace will also be moved to the new namespace. The new namespace will be created by this command and can not already exist. The old namespace will be removed.
        new: (create) - Initialize the scene. Returns untitled scene with default location.
        o: (create) - Open the specified file. Returns the name of the opened file.
        op: (create, query) - Set/query the currently set file options. file options are used while saving a maya file. Two file option flags supported in current file command are v and p.  v(verbose) indicates whether long or short attribute names and command flags names are used when saving the file. Used by both maya ascii and maya binary file formats. It only can be 0 or 1. Setting v=1 indicates that long attribute names and command flag names will be used. By default, or by setting v=0, short attribute names will be used.   p(precision) defines the maya file IO's precision when saving the file. Only used by maya ascii file format. It is an integer value. The default value is 17.  The option format is "flag1=XXX;flag2=XXX".Maya uses the last v and p as the final result. Note: 1. Use a semicolon(";") to separate several flags. 2. No blank space(" ") in option string.
        pns: (query) - Returns the name(s) of a referenced file's parent namespaces.
        pos: (create) - When used with the save flag, the specified script will be executed after the file is saved.
        prs: (create) - When used with the save flag, the specified script will be executed before the file is saved.
        pn: (create) - When used with compress, it will retain the regular extension rather than appending .gz.
        pr: (create) - Modifies the various import/export flags such that references are imported/exported as actual references rather than copies of those references.
        pv: (create) - Used in conjunction with any of the -exportXXX flags, causes Maya to return a list of the nodes that would be exported, without actually writing the exported file to disk.
        ...
        rdn: (create) - When set, Maya will remove imported networks if the same network is also detected in the current scene. You can explicitly specify that certain types of networks be exempted from removal by this flag. For example, if you set to the optionVar removeDuplicateShadingNetworksOnImport to 0 (or disable the option Remove Duplicate Shading Networks from the File > Import options), then shading networks will be exempted from removal by this flag.This flag can only be used in conjunction with the -i/import flag.
        rr: (create) - Remove the given file reference from its parent. This will also Remove everything this file references. Returns the name of the file removed. If the reference is alone in its namespace, remove the namespace. If there are objects remaining in the namespace after the file reference is removed, by default, keep the remaining objects in the namespace. To merge the objects remaining in the namespace to the parent or root namespace, use flags mergeNamespaceWithParent or mergeNamespaceWithRoot. The empty file reference namespace is then removed. To forcibly delete all objects, use flag force. The empty file reference namespace is then removed.
        rn: (create) - Rename the scene. Used mostly during save to set the saveAs name. Returns the new name of the scene.
        ra: (create) - If true, rename all newly-created nodes, not just those whose names clash with existing nodes. Only available with -i/import.
        rts: (create, query) - If true, the scene will need to be renamed before it can be saved. When queried this flag returns true if the scene must be renamed before it can be saved.  The default is false.
        rpr: (create, query) - The string to use as a prefix for all objects from this file. This flag has been replaced by -ns/namespace.
        rpl: (query) - This flag returns a list of all of the renaming prefixes used by the file.
        rep: (create, edit, multiuse, query) - Define a search and replace string. Will apply search and replace to leaf node names. The search string can include namespaces and wild-cards, but will only apply to leaf nodes in a dag hierarchy. Intended for use with offline edits files. May only be used with file -i/import or -r/reference. If a nested reference also defines a substitution, it will become the active substitution table while loading the nested reference. Note: if used with the -e/edit flag, the replacement will only be applied the next time the reference is loaded Examples: -replace "*pCube1" "prop" will change "foo:pCube1" to "foo:prop" and "|A:pCube1|B:pCube1" to "|A:pCube1|prop".
        rvn: (create) - When this flag is enabled namespaces for unloaded references will be created after loading the file to reduce the chances of unexpected namespace collisions when loading or adding references later on.
        rer: (create) - Turn off any pre-existing global file errors.
        rnn: (create) - Used to control the return value in open, import, loadReference, and reference operations. It will force the file command to return a list of new nodes added to the current scene.
        s: (create) - Save the specified file. Returns the name of the saved file.
        sdc: (create, query) - This flag sets the saveAs option for Jiggle disk caches. The valid inputs are "always" - always copy a file texture to a new location, "never" - do not copy at all.  C: The default is "always".  Q: When queried it returns a string ("always", "never").
        sr: (create) - Save reference node edits and connections to reference file. This includes newly added history and animation, provided that these do not apply to any objects outside the reference being saved.
        sru: (create) - This flag can only be used in conjunction with the save flag. It specifies that the saved file will be saved with all references unloaded.
        stx: (create, query) - This flag sets the saveAs option for 3d Paint file textures. The valid inputs are "always" - always copy a file texture to a new location, "unlessRef" - copy only if this is not a referenced file texture, "never" - do not copy at all.  C: The default is "unlessRef".  Q: When queried it returns a string ("always", unlessRef", "never").
        sn: (query) - return the name of the current scene.
        seg: () - This flag is obsolete.
        sa: (create) - Select all the components of this file as well as its child files.  Note that the file specified must be one that is already opened in this Maya session. The default behavior is to replace the existing selection. Use with the "add" flag to keep the active selection list.
        sh: (create, query) - For use with exportSelected to specify whether attached shaders should be included in the export.
        ...
        shn: (query) - When used with a main query flag it indicates that the file name returned will be the short name (i.e., just a file name without any directory paths). If this flag is not present, the full name and directory path will be returned.
        str: (create) - Set strict file path resolution. If true, all paths will be matched exactly, both relative and absolute. Relative paths will be considered relative to the project root directory. May only be used with the -o/open, -i/import, -ir/importReference or -r/reference flags.
        ...
        typ: (create, query) - Set the type of this file.  By default this can be any one of: "mayaAscii", "mayaBinary", "mel",  "OBJ", "directory", "plug-in", "audio", "move", "EPS", "Adobe(R) Illustrator(R)", "image" plug-ins may define their own types as well. Return a string array of file types that match this file.
        uc: (create, query) - Save the ui configuration with the scene in a uiConfiguration script node. (eg. panes, etc.) The current default is on and is set in initialStartup.mel.
        ulc: (create, query) - Load the scene's ui configuration. (eg. panes, etc.) The current default is on and is set in initialStartup.mel.
        ur: (create) - This flag will unload the reference file associated with the passed reference node.
        un: (query) - When used with a main query flag it indicates that the file name returned will be unresolved (i.e., it will be the path originally specified when the file was loaded into Maya; this path may contain environment variables and may not exist on disk). If this flag is not present, the resolved name will be returned.
        uns: (query) - Returns boolean. Queries whether the specified reference file uses namespaces or renaming prefixes.
        wcn: (query) - When used with a main query flag it indicates that the file name returned will not have a copy number appended to the end. If this flag is not present, the file name returned may have a copy number appended to the end.
        w: (query) - Query whether the given file is writable in the current scene. For main scene files this indicates writable to the file system by the current user. Files referenced by the main scene file are always not writable (referenced files are by nature read only). Files not present in the current scene always return false.
    """
    ...


def fileBrowserDialog(*args, an: Optional[Union[str, bool]] = ..., ds: Optional[Union[int, bool]] = ..., fc: Optional[Union[str, bool]] = ..., ft: Optional[Union[str, bool]] = ..., fl: Optional[Union[str, bool]] = ..., includeName: Optional[Union[str, bool]] = ..., m: Optional[Union[int, bool]] = ..., om: Optional[Union[str, bool]] = ..., tm: Optional[Union[str, bool]] = ..., wt: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        an: (create) - Script to be called when the file is validated.
        ds: (create) - 0 for old style dialog 1 for Windows 2000 style Explorer style 2 for Explorer style with "Shortcut" tip at bottom
        fc: (create) - The script to run on command action
        ft: (create) - Set the type of file to filter.  By default this can be any one of: "mayaAscii", "mayaBinary", "mel", "OBJ", "directory", "plug-in", "audio", "move", "EPS", "Illustrator", "image". plug-ins may define their own types as well.
        fl: (create, multiuse) - Specify file filters. Used with dialog style 1 and 2. Each string should be a description followed by a comma followed by a semi-colon separated list of file extensions with wildcard.
        ...
        m: (create) - Defines the mode in which to run the file brower:  0 for read 1 for write 2 for write without paths (segmented files) 4 for directories have meaning when used with the action  +100 for returning short names
        om: (create) - Enables the option dialog. Valid strings are:  "Import" "Reference" "SaveAs" "ExportAll" "ExportActive"
        tm: (create) - Message to be displayed at the bottom of the style 2 dialog box.
        wt: (create) - Set the window title of a style 1 or 2 dialog box
    """
    ...


def fileDialog(*args, app: bool = ..., dfn: Optional[Union[str, bool]] = ..., dm: Optional[Union[str, bool]] = ..., m: Optional[Union[int, bool]] = ..., t: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    The fileBrowserDialog and fileDialog commands have now been deprecated.
    Both commands are still callable, but it is recommended that the fileDialog2 command
    be used instead.  To maintain some backwards compatibility, both fileBrowserDialog and
    ...
    Args:
        app: (create) - This is a "Mac" only flag. This brings up the dialog which selects only the application bundle.
        dfn: (create) - Set default file name. This flag is available under "write" mode
        dm: (create) - This can be used to specify what directory and file names will be displayed in the dialog.  If not specified, the current directory will be used, with all files displayed. The string may contain a path name, and must contain a wild-carded file specifier. (eg "*.cc" or "/usr/u/*") If just a path is specified, then the last directory in the path is taken to be a file specifier, and this will not produce the desired results.
        m: (create) - Defines the mode in which to run the file dialog:  0 for read 1 for write  Write mode can not be used in conjunction with the -application flag.
        t: (create) - Set title text. The default value under "write" mode is "Save As". The default value under "read" mode is "Open".
    """
    ...


def fileDialog2(*args, bbo: Optional[Union[int, bool]] = ..., cc: Optional[Union[str, bool]] = ..., cap: Optional[Union[str, bool]] = ..., ds: Optional[Union[int, bool]] = ..., ff: Optional[Union[str, bool]] = ..., fm: Optional[Union[int, bool]] = ..., ftc: Optional[Union[str, bool]] = ..., hne: bool = ..., okc: Optional[Union[str, bool]] = ..., oca: Optional[Union[str, bool]] = ..., ocm: Optional[Union[str, bool]] = ..., oc2: Optional[Union[str, bool]] = ..., ocr: Optional[Union[str, bool]] = ..., oin: Optional[Union[str, bool]] = ..., oti: Optional[Union[str, bool]] = ..., rf: bool = ..., sff: Optional[Union[str, bool]] = ..., sc: Optional[Union[str, bool]] = ..., spe: bool = ..., dir: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    This command provides a dialog that allows users to select files or directories.

    Args:
        bbo: (create) - 1 Vertical button box layout. Cancel button is below the accept button.  2 Horizontal button box layout. Cancel button is to the right of the accept button.
        cc: (create) - If the dialogStyle flag is set to 2 then this provides a caption for the Cancel button within the dialog.
        cap: (create) - Provide a title for the dialog.
        ds: (create) - 1 On Windows or Mac OS X will use a native style file dialog. 2 Use a custom file dialog with a style that is consistent across platforms.
        ff: (create) - Provide a list of file type filters to the dialog.  Multiple filters should be separated by double semi-colons.  See the examples section.
        fm: (create) - Indicate what the dialog is to return.  0 Any file, whether it exists or not. 1 A single existing file. 2 The name of a directory.  Both directories and files are displayed in the dialog. 3 The name of a directory.  Only directories are displayed in the dialog. 4 The names of one or more existing files.
        ftc: (create) - MEL only.  The string is interpreted as a MEL callback, to be called when the user-selected file type changes.  The callback is of the form:  global proc MyCustomFileTypeChanged(string $parent, string $newType)  The parent argument is the parent layout into which controls have been added using the optionsUICreate flag.  The newType argument is the new file type.
        hne: (create) - Hide name editing input field.
        okc: (create) - If the dialogStyle flag is set to 2 then this provides a caption for the OK, or Accept, button within the dialog.
        oca: (create) - MEL only.  The string is interpreted as a MEL callback, to be called when the dialog is cancelled (with Cancel button or close button to close window). The callback is of the form:  global proc MyCustomOptionsUICancel()
        ocm: (create) - MEL only.  The string is interpreted as a MEL callback, to be called when the dialog is successfully dismissed.  It will not be called if the user cancels the dialog, or closes the window using window title bar controls or other window system means.  The callback is of the form:  global proc MyCustomOptionsUICommit(string $parent)  The parent argument is the parent layout into which controls have been added using the optionsUICreate flag.
        oc2: (create) - MEL only.  As optionsUICommit, the given string is interpreted as a MEL callback, to be called when the dialog is successfully dismissed. The difference is that this callback takes one additional argument which is the file name selected by the user before the dialog validation. It will not be called if the user cancels the dialog, or closes the window using window title bar controls or other window system means.  The callback is of the form:  global proc MyCustomOptionsUICommit(string $parent, string $selectedFile)  The parent argument is the parent layout into which controls have been added using the optionsUICreate flag.
        ocr: (create) - MEL only.  The string is interpreted as a MEL callback, to be called on creation of the file dialog.  The callback is of the form:  global proc MyCustomOptionsUISetup(string $parent)  The parent argument is the parent layout into which controls can be added.  This parent is the right-hand pane of the file dialog.
        oin: (create) - MEL only.  The string is interpreted as a MEL callback, to be called just after file dialog creation, to initialize controls.  The callback is of the form:  global proc MyCustomOptionsUIInitValues(string $parent, string $filterType)  The parent argument is the parent layout into which controls have been added using the optionsUICreate flag.  The filterType argument is the initial file filter.
        oti: (create) - MEL only. If optionsUICreate is set, user can set a custom title to their option window using this flag. If no title is desired, an empty string i.e. "" can be used.
        rf: (create) - If true, the selected filter will be returned as the last item in the string array along with the selected files.
        sff: (create) - Specify the initial file filter to select.  Specify just the begining text and not the full wildcard spec.
        ...
        spe: (create) - Define whether the project button should be enabled
        dir: (create) - Provide the starting directory for the dialog.
    """
    ...


def fileInfo(*args, rfn: Optional[Union[str, bool]] = ..., rm: Optional[Union[str, bool]] = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        rfn: (query) - Specify the name of a referenceNode to indicate the scene file to query. This flag is only valid during query. 			In query mode, this flag needs a value.
        rm: (create, query) - If the remove flag is specified, the string following it is a keyword to remove from the list of fileInfo to be saved with the scene file.
    """
    ...


def filePathEditor(*args, ao: bool = ..., at: Optional[Union[str, bool]] = ..., bt: Optional[Union[str, bool]] = ..., cr: Optional[Union[Tuple[str, str], bool]] = ..., dt: Optional[Union[str, bool]] = ..., f: bool = ..., ld: Optional[Union[str, bool]] = ..., lf: Optional[Union[str, bool]] = ..., lrt: bool = ..., p: bool = ..., rc: bool = ..., rf: bool = ..., rt: Optional[Union[str, bool]] = ..., rel: bool = ..., r: Optional[Union[str, bool]] = ..., ra: bool = ..., rfd: Optional[Union[str, bool]] = ..., rs: Optional[Union[Tuple[str, str], bool]] = ..., s: bool = ..., tmp: bool = ..., tl: Optional[Union[str, bool]] = ..., u: bool = ..., wa: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ao: (query) - Used with "listFiles" to return the node and attribute name that are using the files.
        at: (query) - Query the attribute type for the specified plug.
        bt: (query) - Used with "listFiles" to query files that are used by the specified node type or attribute type. 			In query mode, this flag needs a value.
        cr: (create) - Copy a source file to the destination path and repath the plug data to the new file. The source file must have the same name as the one in the plug. The command will look for the file at the specified location first. If not found, the command will try to use the original file in the plug. If the file is still not found, nothing is done.
        dt: (create) - Deregister a file type from the list of registered types so the command stops handling it. Unless the "temporary" flag is used, the type will be removed from the preferences will not reappear on application restart. When the "temporary" flag is specified, the deregistration is only effective for the current session. The deregistration will be rejected if the type has already been unregistered. However, it is valid to deregister permanently (without the "temporary" flag) a type after it has been temporarily deregistered.
        f: (create) - Used with flag "repath" to repath all files to the new location, including the resolved files. Otherwise, "repath" will only deal with the missing files. Used with flag "copyAndRepath" to overwrite any colliding file at the destination. Otherwise, "copyAndRepath" will use the existing file at the destination instead of overwriting it. The default value is off.
        ld: (query) - List all sub directories of the specified directory.  Only directories containing at least one file whose type is registered (see "registerType") will be listed. If no directory is provided, all directories applicable to the scene will be returned. 			In query mode, this flag needs a value.
        lf: (query) - List files in the specified directory. No recursion in subdirectories will be performed. 			In query mode, this flag needs a value.
        lrt: (query) - Query the list of registered attribute types. The registered types include the auto-loaded types from the preference file and the types explicitly registered by the user, both with and without the "temporary" flag.
        p: (create) - Used with "repath", "replaceString" or "copyAndRepath" to preview the result of the operation instead of excuting it. When it is used with "repath" or "replaceString", the command returns the new file path and a status flag indicating whether the new file exists (1) or not (0). The path name and the file status are listed in pairs. When it is used with "copyAndRepath", the command returns the files that need copying.
        ...
        rf: (create) - Clear and re-collect the file information in the scene. The command does not automatically track file path modifications in the scene. So it is the users responsibility to cause refreshes in order to get up-to-date information.
        rt: (create) - Register a new file type that the command will handle and recognize from now on. Unless the "temporary" flag is used, the registered type is saved in the preferences and reappears on application restart. The new type will be rejected if it collides with an existing type or label. One exception to this is when registering a type without the "temporary" flag after the type has been registered with it. This is considered as modifying the persistent/temporary property of the existing type, rather than registering a new type.
        rel: (query) - Used with "listDirectories" or "listFiles" to return the relative path of each directory or file.  Paths are relative to the current project folder. If a file or the directory is not under the current project folder, the returned path will still be a full path.
        r: (create) - Replace the directory part of a file path with a specified location. The file name will be preserved.
        ra: (create) - Used with flag "replaceString", specifies how many times the matched string will be replaced. When the flag is false, only the first matched string will be replaced. Otherwise, all matched strings will be replaced. The default value is false.
        rfd: (create) - Used with the "replaceString" flag to control the scope of the replacement. Possible values are: "pathOnly" - only replace strings in the directory part. "nameOnly" - only replace strings in the file name, without the directory. "fullPath" - replace strings anywhere in the full name. The default argument is "fullPath".
        rs: (create) - Replace the target string with the new string in the file paths. The flag needs two arguments: the first one is the target string and the second one is the new string. See the "replaceField" and "replaceAll" flags to control how the replacement is performed.
        s: (query) - Used with "listFiles", this will cause the returned list of files to include one status flag per file: 0 if it cannot be resolved and 1 if it can. Used with "listDirectories", this will cause the returned list of directories to include one status flag per directory: 0 if it cannot be resolved, 1 if it can and 2 if the resolution is partial. The status will be interleaved with the file/directory names, with the name appearing first. See the example for "listFiles".  See the "withAttribute" flag for another way of getting per-file information.  When multiple per-entry items appear in the list (e.g.: plug name), the status is always last.
        tmp: (create) - Make the effect of the "register"/"deregister" flag only applicable in the current session. Normally, a type registration/deregistration is permanent and is made persistent via a preference file. When the "temporary" flag is specified, the changes will not be saved to the preference file. When the application restarts, any type that has been previously temporarily registered will not appear and any type that was temporarily deregistered will re-appear.
        ...
        u: (query) - Used with "listFiles" to query the unresolved files that are being used in the scene.
        wa: (query) - Used with "listFiles" to return the name of the plug using a given file. For example, if "file.jpg" is used by the plug "node1.fileTextureName", then the returned string will become the pair "file.jpg node1.fileTextureName".  See the "status" flag for another way to get per-file information.
    """
    ...


def filterStudioImport(*args, sp: bool = ..., ic: bool = ..., il: bool = ..., td: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        sp: (create) - If true, shells in the input will be converted to triangular meshes.     If false, any/all shells encountered will be groups of surfaces.
        ic: (create) - If true, cameras in the input to "studioImport" will be translated.     If false, any/all cameras encountered by "studioImport" will be ignored.
        il: (create) - If true, lights in the input to "studioImport" will be translated.     If false, any/all lights encountered by "studioImport" will be ignored.
        td: (create) - If set (non-empty), use as directory for storing imbedded binary files,     else use the directory given by "theTempDirectory->fullName()".
    """
    ...


def findType(*args, d: bool = ..., e: bool = ..., f: bool = ..., t: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        d: (create) - Find all nodes of the given type instead of just the first.
        e: (create) - Match node types exactly instead of any in a node hierarchy.
        f: (create) - Look forwards (downstream) through the graph rather than backwards (upstream) for matching nodes.
        t: (create) - Type of node to look for (e.g. "transform"). This flag is mandatory.
    """
    ...
...
def format(*args, s: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        s: (create, multiuse) - Specify the arguments for the format string.
    """
    ...


def getFileList(*args, fs: Optional[Union[str, bool]] = ..., fld: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        fs: (create) - wildcard specifier for search.
        fld: (create) - return a directory listing
    """
    ...


def getInputDeviceRange(*args, max: bool = ..., min: bool = ...) -> Any:
    r"""
    ...
    Args:
        max: (create) - list only the maximum value of the axis
        min: (create) - list only the minimum value of the axis
    """
    ...
...
def getModulePath(*args, mn: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    Returns the module path for a given module name.

    Args:
        mn: (create) - The name of the module whose path you want to retrieve.
    """
    ...


def hardware(*args, brd: bool = ..., cpu: bool = ..., gfx: bool = ..., mhz: bool = ..., npr: bool = ...) -> Any:
    r"""
    Return description of the hardware available in the machine.

    Args:
        brd: (create) - Returns IP number identifying the CPU motherboard
        cpu: (create) - Returns type of CPU
        gfx: (create) - Returns string identifying graphics hardware type
        mhz: (create) - Returns string identifying the speed of the CPU chip
        npr: (create) - Returns string identifying the number of processors
    """
    ...


def help(*args, doc: bool = ..., lng: Optional[Union[str, bool]] = ..., l: bool = ..., pdt: Optional[Union[int, bool]] = ..., pm: bool = ..., ppt: Optional[Union[int, bool]] = ..., psm: bool = ..., rm: bool = ..., so: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    *            matches any string
    ...
    Args:
        doc: (create) - Use a browser to show the documentation associated with the single command name given. A pattern cannot be used with this flag. If no command name is specified, then this flag will go to the main documentation index.
        lng: (create) - Show the help for this command in the specified language. Valid values are "mel" and "python". The default is Mel. Used with the doc flag.
        l: (create) - List all the commands whose names match the regular expression. Pass the regular expression as the first argument to the command specified.
        pdt: (create, query) - Set the amount of time, in seconds, that the popup help will be displayed.  The default is 4 seconds. This flag is mutually exclusive of the list and doc flags.
        pm: (create, query) - Turn on or off popup help mode.  This flag is mutually exclusive of the list and doc flags.
        ppt: (create, query) - Set the amount of time, in milliseconds, before the popup help will be displayed. The default is 800 milliseconds. This flag is mutually exclusive of the list and doc flags.
        psm: (create, query) - Turn on or off simple popup help mode. If set, ToolClips will display only name and keyboard shortcut.
        rm: (create, query) - Turn on or off rollover help mode.  This flag is mutually exclusive with the list and doc flags.
        so: (create) - When no other flag is specified, return only the syntax part of the quick help.
    """
    ...
...
def imfPlugins(*args, ext: Optional[Union[str, bool]] = ..., key: Optional[Union[str, bool]] = ..., mfs: Optional[Union[str, bool]] = ..., pn: Optional[Union[str, bool]] = ..., rs: Optional[Union[str, bool]] = ..., ws: Optional[Union[str, bool]] = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ext: (create, query) - image file extension
        key: (create, query) - imf keyword
        mfs: (create, query) - multi frame IO is supported
        pn: (create, query) - imf plugin name
        rs: (create, query) - read operation is supported
        ws: (create, query) - write operation is supported
    """
    ...


def internalVar(*args, mid: bool = ..., uad: bool = ..., ubd: bool = ..., uhk: bool = ..., umm: bool = ..., upd: bool = ..., ups: bool = ..., usd: bool = ..., ush: bool = ..., utd: bool = ..., uwd: bool = ...) -> Any:
    r"""
    This command returns the values of internal variables.  No modification
    of these variables is supported.

    Args:
        mid: (create) - Return the Maya installation directory.
        uad: (create) - Return the user application directory.
        ubd: (create) - Return the user bitmaps prefs directory.
        uhk: (create) - Return the user hotkey directory.
        umm: (create) - Return the user marking menu directory.
        upd: (create) - Return the user preference directory.
        ups: (create) - Return the user presets directory.
        usd: (create) - Return the user script directory.
        ush: (create) - Return the user shelves directory.
        utd: (create) - Return a temp directory.  Will check for TMPDIR environment variable, otherwise will return the current directory.
        uwd: (create) - Return the user workspace directory (also known as the projects directory).
    """
    ...


def launch(*args, dir: Optional[Union[str, bool]] = ..., mov: Optional[Union[str, bool]] = ..., pdf: Optional[Union[str, bool]] = ..., web: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        ...
        mov: (create) - A movie file. The only acceptable movie file formats are MPEG, Quicktime, and Windows Media file. The file's name must end with .mpg, .mpeg, .mp4, .wmv, .mov, or .qt.
        pdf: (create) - A PDF (Portable Document Format) document. The file's name must end with .pdf.
        web: (create) - A web page.
    """
    ...


def launchImageEditor(*args, eif: Optional[Union[str, bool]] = ..., vif: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        eif: (create) - If the file is a PSD, then the specified verison of Photoshop is launched, and the file is opened in it. If file is any other image type, then the preferred image editor is launched, and the file is opened in it.
        vif: (create) - Opens up an Image editor to view images.
    """
    ...


def listDeviceAttachments(*args, at: Optional[Union[str, bool]] = ..., ax: Optional[Union[str, bool]] = ..., c: Optional[Union[str, bool]] = ..., d: Optional[Union[str, bool]] = ..., f: Optional[Union[str, bool]] = ..., sl: bool = ..., w: bool = ...) -> Any:
    r"""
    ...
    Args:
        at: (create) - specify the attribute attachments to list
        ax: (create) - specify the axis attachments to list
        c: (create) - List only attachment clutched with this button
        d: (create) - specify which device attachments to list
        f: (create) - Specify the name of the file to write out device attachments.
        sl: (create) - This flag list only attachments on selection
        w: (create) - Write out device attachments to a file specified by the -f flag, is set.  If -f is not set, it'll write out to a file named for the device.
    """
    ...
...
def listInputDevices(*args, f: bool = ..., p: bool = ..., s: bool = ...) -> Any:
    r"""
    This command lists all input devices that maya knows about.

    Args:
        f: (create) - List the free devices
        p: (create) - List the primary devices
        s: (create) - List the secondary devices
    """
    ...


def loadModule(*args, a: bool = ..., ld: Optional[Union[str, bool]] = ..., sc: bool = ...) -> Any:
    r"""
    ...
    Args:
        a: (create) - Load all new modules not yet loaded in Maya. New modules are the one returned by the -scan option.
        ld: (create) - Load the module specified by the module definition file.
        sc: (create) - Rescan module presence. Returns the list of module definition files found and not yet loaded into Maya. Does not load any of these newly found modules, nor change the Maya state.
    """
    ...


def loadPlugin(*args, ac: Optional[Union[str, bool]] = ..., a: bool = ..., n: Optional[Union[str, bool]] = ..., qt: bool = ..., rc: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        ac: (create) - Add a MEL or Python callback script to be called after a plug-in is loaded.  For MEL, the procedure should have the following signature: global proc procedureName(string $pluginName).  For Python, you may specify either a script as a string, or a Python callable object such as a function.  If you specify a string, then put the formatting specifier "%s" where you want the name of the plug-in to be inserted.  If you specify a callable such as a function, then the name of the plug-in will be passed as an argument.
        a: (create) - Cause all plug-ins in the search path specified in MAYA_PLUG_IN_PATH to be loaded.
        n: (create) - Set a user defined name for the plug-ins that are loaded.  If the name is already taken, then a number will be added to the end of the name to make it unique.
        qt: (create) - Don't print a warning if you attempt to load a plug-in that is already loaded.
        rc: (create) - Removes a procedure which was previously added with -addCallback.
    """
    ...
...
def memory(*args, av: bool = ..., af: bool = ..., dbg: bool = ..., fr: bool = ..., gb: bool = ..., he: bool = ..., kb: bool = ..., mb: bool = ..., pf: bool = ..., pr: bool = ..., phy: bool = ..., pv: bool = ..., sum: bool = ..., swf: bool = ..., swl: bool = ..., swm: bool = ..., swp: bool = ..., swr: bool = ..., swv: bool = ..., sw: bool = ...) -> Any:
    r"""
    ...
    Args:
        av: (create) - Returns size of adjusted virtual memory allocated by the process. The adjustment is done by computing an offset when the application is launched that will be subtracted from the process virtual memory in order to give the adjusted value.  The returned size is an approximation of the memory used by the process that can be more reliable in some cases, for instance on platforms where display drivers can reserve large ranges of memory addresses, therefore increasing the size of the process virtual memory, even though those addresses are actually not used.
        af: (create) - Causes numeric values to be returned as floats rather than ints. This can be useful if you wish to retain some of the significant digits lost when using the unit size flags.
        dbg: (create) - Print debugging statistics on arena memory (if it exists)
        fr: (create) - Returns size of free memory
        gb: (create) - Return memory sizes in gigabytes (1024*1024*1024 bytes)
        he: (create) - Returns size of memory heap
        kb: (create) - Return memory sizes in kilobytes (1024 bytes)
        mb: (create) - Return memory sizes in megabytes (1024*1024 bytes)
        pf: (create) - Returns number of page faults
        pr: (create) - Returns number of page reclaims
        phy: (create) - Returns size of physical memory
        pv: (create) - Returns size of virtual memory allocated by the process
        sum: (create) - Returns a summary of memory usage. The size flags are ignored and all memory sizes are given in megabytes.
        swf: (create) - Returns size of free swap
        swl: (create) - Returns size of logical swap
        swm: (create) - Returns maximum swap size
        swp: (create) - Returns size of physical swap
        swr: (create) - Returns size of reserved swap
        swv: (create) - Returns size of virtual swap
        sw: (create) - Returns number of swaps
    """
    ...


def moduleInfo(*args, d: bool = ..., lm: bool = ..., mn: Optional[Union[str, bool]] = ..., p: bool = ..., v: bool = ...) -> Any:
    r"""
    Returns information on modules found by Maya.

    Args:
        d: (create) - Returns module definition file name for the module specified by the -moduleName parameter.
        lm: (create) - Returns an array containing the names of all currently loaded modules.
        mn: (create) - The name of the module whose information you want to retrieve. Has to be used with either -definition / -path / -version flags.
        p: (create) - Returns the module path for the module specified by the -moduleName parameter.
        v: (create) - Returns the module version for the module specified by the -moduleName parameter.
    """
    ...


def mouse(*args, esw: bool = ..., mbt: Optional[Union[int, bool]] = ..., mbs: bool = ..., sws: bool = ...) -> Any:
    r"""
    This command allows to configure mouse.

    Args:
        esw: (create) - Enable or disable scroll wheel support.
        mbt: (create) - Set the number (1, 2 or 3) of mouse buttons to track. Note: this is only supported on Macintosh
        mbs: (create) - returns the current number of mouse buttons being tracked.
        sws: (create) - returns the current status of scroll wheel support.
    """
    ...


def namespace(*args, an: bool = ..., add: Optional[Union[str, bool]] = ..., ch: Optional[Union[str, bool]] = ..., dnc: bool = ..., ex: Optional[Union[str, bool]] = ..., f: bool = ..., ir: Optional[Union[str, bool]] = ..., mno: Optional[Union[str, bool]] = ..., mnp: bool = ..., mnr: bool = ..., mv: Optional[Union[Tuple[str, str], bool]] = ..., p: Optional[Union[str, bool]] = ..., r: bool = ..., rel: bool = ..., rm: Optional[Union[str, bool]] = ..., ren: Optional[Union[Tuple[str, str], bool]] = ..., set: Optional[Union[str, bool]] = ..., vn: Optional[Union[str, bool]] = ..., query: bool = ...) -> Any:
    r"""
...
def namespaceInfo(*args, an: bool = ..., bn: bool = ..., cur: bool = ..., dp: bool = ..., fn: bool = ..., int: bool = ..., ir: bool = ..., ls: bool = ..., lod: bool = ..., lon: bool = ..., p: bool = ..., r: bool = ..., sn: bool = ...) -> Any:
    ...
    Args:
        an: (create) - This is a general flag which can be used to specify the desired format for the namespace(s) returned by the command. The absolute name of the namespace is a full namespace path, starting from the root namespace ":" and including all parent namespaces.  For example ":ns:ball" is an absolute namespace name while "ns:ball" is not. The absolute namespace name is invariant and is not affected by the current namespace or relative namespace modes. See also other format modifiers 'baseName', 'fullName', etc
        bn: (create) - This is a general flag which can be used to specify the desired format for the namespace(s) returned by the command. The base name of the namespace contains only the leaf level name and does not contain its parent namespace(s). For example the base name of an object named "ns:ball" is "ball". This mode will always return the base name in the same manner, and is not affected by the current namespace or relative namespace mode. See also other format modifiers 'absoluteName', 'fullName', etc The flag 'shortName' is a synonym for 'baseName'.
        cur: (create) - Display the name of the current namespace.
        dp: (create) - This flag modifies the 'listNamespace' and 'listOnlyDependencyNodes' flags to indicate that the names of any dag objects returned will include as much of the dag path as is necessary to make the names unique. If this flag is not present, the names returned will not include any dag paths.
        fn: (create) - This is a general flag which can be used to specify the desired format for the namespace(s) returned by the command. The full name of the namespace contains both the namespace path and the base name, but without the leading colon representing the root namespace. For example "ns:ball" is a full name, whereas ":ns:ball" is an absolute name. This mode is affected by the current namespace and relative namespace modes. See also other format modifiers 'baseName', 'absoluteName', etc.
        int: (create) - This flag is used together with the 'listOnlyDependencyNodes' flag. When this flag is set, the returned list will include internal nodes (for example itemFilters) that are not listed by default.
        ir: (create) - Returns true if the namespace is root(":"), false if not.
        ls: (create) - List the contents of the namespace.
        lod: (create) - List all dependency nodes in the namespace.
        lon: (create) - List all namespaces in the namespace.
        p: (create) - Display the parent of the namespace. By default, the list returned will not include internal nodes (such as itemFilters). To include the internal nodes, use the 'internal' flag.
        r: (create) - Can be specified with 'listNamespace', 'listOnlyNamespaces' or 'listOnlyDependencyNode' to cause the listing to recursively include any child namespaces of the namespaces;
        sn: (create) - This flag is deprecated and may be removed in future releases of Maya. It is a synonym for the baseName flag. Please use the baseName flag instead.
    """
    ...


def ogs(*args, di: bool = ..., drt: bool = ..., dt: Optional[Union[str, bool]] = ..., hwi: bool = ..., fe: Optional[Union[str, bool]] = ..., xml: Optional[Union[str, bool]] = ..., gmt: Optional[Union[int, bool]] = ..., gpu: bool = ..., lve: bool = ..., rgl: bool = ..., irs: bool = ..., p: bool = ..., rbt: bool = ..., rup: Optional[Union[str, bool]] = ..., rlt: bool = ..., r: bool = ..., ss: Optional[Union[str, bool]] = ..., ttp: bool = ..., trp: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        di: (create) - If used then output the current device information.
        drt: (create) - Clear up all the releasable file textures in GPU memory that are not required for rendering.
        dt: (create) - If used then dump GPU texture memory usage info (in MB), must be used with FLAG gpuMemoryUsed. The final info detail is specified by the string parameter. Current available values are: "full" , "total".
        hwi: (create) - Enables/disables new gpu instancing of instanceable render items in OGS.
        fe: (create) - If used then launch the fragment editor UI.
        xml: (create) - Get the fragment XML associated with a shading node.
        gmt: (create, query) - Get or set the total amount of GPU memory which Maya is allowed to use (in MB).
        gpu: (create) - If used then output the estimated amount of GPU memory in use (in MB).
        lve: (query) - To query if the legacy viewport is enabled.
        rgl: (query) - Query if remote gl is allowed
        irs: (query) - Query if this is a remote session.
        p: (create, query) - Toggle pausing VP2 display update
        rbt: (create) - If used then re-bake all baked textures for OGS.
        rup: (create) - If used then regenerate all UV tiles preview textures for OGS.
        rlt: (create) - If used then reload all textures for OGS.
        r: (create, query) - If used then reset the entire OGS database for all viewports using it. In query mode the number of viewports that would be affected is returned but the reset is not actually done.  If no viewport is using OGS then OGS will stop listening to DG changes.
        ss: (query) - Get the shader source for the specified material.
        ttp: (create) - If used then toggle the default OGS Texture paging mechanism.
        trp: (create) - Enable debug tracing of the renderer pipeline.
    """
    ...


def openCLInfo(*args, lmv: bool = ..., mvb: Optional[Union[int, bool]] = ..., dbl: bool = ..., v: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ...
        mvb: (create, query) - Set the minimum vert count under which the geometry will not be allowed on the GPU (unless in a network with qualifying geometries). This is only used for debugging purposes and is not saved to the file or any preferences.
        dbl: (create, query) - Specifies whether double precision can be used in OpenCL. If the platform can not allow double precision this can not be set to "on".
        v: (query) - Valid in query mode only. Checks if OpenCL is initialized.
    """
    ...


def openGLExtension(*args, ext: Optional[Union[str, bool]] = ..., rnd: bool = ..., vnd: bool = ..., ver: bool = ...) -> Any:
    r"""
...
def pluginDisplayFilter(*args, cls: Optional[Union[str, bool]] = ..., dr: bool = ..., ex: bool = ..., l: Optional[Union[str, bool]] = ..., lf: bool = ..., r: bool = ..., query: bool = ...) -> Any:
    ...
    Args:
        cls: (create, query) - The classification used to filter objects in Viewport 2.0. This classification is the same as MFnPlugin::registerNode(). If the node was registered with multiple classifications, use the one beginning with "drawdb". The default value of this flag is an empty string (""). It will not filter any objects in Viewport 2.0.
        dr: (create) - Deregister a plugin display filter.
        ex: (create) - Returns true if the specified filter exists, false otherwise. Other flags are ignored.
        l: (create, query) - The string to be displayed for this filter in the UI. E.g. in the 'Show' menu of a model panel. The default value of this flag is the same as the plugin display filter name.
        lf: (query) - Returns an array of all plugin display filters.
        r: (create) - Register a plugin display filter. The -register is implied if both -register and -deregister flags are missing in create mode. You are responsible for deregistering any filters which you register. Filters are reference counted, meaning that if you register the same filter twice then you will have to deregister it twice as well.
    """
    ...


def pluginInfo(*args, af: bool = ..., ae: bool = ..., aci: Optional[Union[str, bool]] = ..., av: bool = ..., a: bool = ..., cf: bool = ..., cc: Optional[Union[str, bool]] = ..., c: Optional[Union[str, bool]] = ..., cnc: bool = ..., ctc: bool = ..., d: Optional[Union[Tuple[str, str], bool]] = ..., dn: bool = ..., dnt: Optional[Union[str, bool]] = ..., dni: Optional[Union[str, bool]] = ..., dv: bool = ..., ddb: bool = ..., e: bool = ..., ik: bool = ..., ls: bool = ..., lsp: bool = ..., lpp: bool = ..., l: bool = ..., mec: bool = ..., n: Optional[Union[str, bool]] = ..., p: Optional[Union[str, bool]] = ..., pu: bool = ..., rtr: bool = ..., r: bool = ..., rm: bool = ..., rdr: bool = ..., spp: bool = ..., sd: bool = ..., set: bool = ..., t: Optional[Union[str, bool]] = ..., tr: bool = ..., uo: bool = ..., u: bool = ..., vd: Optional[Union[str, bool]] = ..., v: bool = ..., wr: bool = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        af: (query) - Restricts the command to the active file only, not the entire scene. This only affects the dependNode/dn and pluginsInUse/pu flags. For use during export selected.
        ae: (query) - Returns a string array containing the names of all of the evaluator types registered to any plug-in.
        aci: (query) - Returns a string array containing the names of all of the animation curve interpolators registered by this plug-in.
        av: (query) - Returns a string containing the version of the API that this plug-in was compiled with.  See the comments in MTypes.h for the details on how to interpret this value.
        a: (create, edit, query) - Sets whether or not this plug-in should be loaded every time the application starts up. Returns a boolean in query mode.
        cf: (query) - Returns a string array containing the names of all of the registered geometry cache formats
        cc: (create) - Adds a callback that will get executed every time the plug-in registry changes. Any other previously registered callbacks will also get called.
        c: (multiuse, query) - Returns a string array containing the names of all of the normal commands registered by this plug-in. Constraint, control, context and model editor commands are not included.
        cnc: (query) - Returns a string array containing the names of all of the constraint commands registered by this plug-in.
        ctc: (query) - Returns a string array containing the names of all of the control commands registered by this plug-in.
        d: (multiuse, query) - Returns a string array containing the names of all of the data types registered by this plug-in.
        dn: (multiuse, query) - Returns a string array containing the names of all of the custom nodes types registered by this plug-in.
        ...
        dni: (query) - Returns an integer array containing the ids of all of the custom node types registered by this plug-in.
        dv: (query) - Returns a string array containing the names of all of the devices registered by this plug-in.
        ddb: (query) - Returns a string array containing the names of all of the drag and drop behaviors registered by this plug-in.
        e: (query) - Returns a string array containing the names of all of the evaluator types registered by this plug-in.
        ik: (query) - Returns a string array containing the names of all of the ik solvers registered by this plug-in.
        ls: (query) - Returns a string array containing all the plug-ins that are currently loaded.
        lsp: (query) - Returns a string array containing the full paths of all the plug-ins that are currently loaded.
        lpp: (create) - Loads the plug-in preferences (ie. autoload) from pluginPrefs.mel into Maya.
        l: (query) - Returns a boolean specifying whether or not the plug-in is loaded.
        mec: (query) - Returns a string array containing the names of all of the model editor commands registered by this plug-in.
        n: (query) - Returns a string containing the internal name by which the plug-in is registered.
        p: (query) - Returns a string containing the absolute path name to the plug-in.
        pu: (query) - Returns a string array containing all the plug-ins that are currently being used in the scene.
        rtr: (query) - If this flag is used in conjunction with the pluginsInUse/pu flag then it will modify the output. When true it will only show plug-ins currently in use containing translators that are used to load referenced files. When false it will only show plug-ins not containing such translators.
        r: (query) - Returns a boolean specifying whether or not plug-in is currently registered with the system.
        rm: (edit) - Removes the given plug-in's record from the registry. There is no return value.
        rdr: (query) - Returns a string array containing the names of all of the renderers registered by this plug-in.
        spp: (create) - Saves the plug-in preferences (ie. autoload) out to pluginPrefs.mel
        sd: (query) - If there are services in use, then this flag will return a string array containing short descriptions saying what those services are.
        set: (query) - Returns an array of values with the loaded, autoload, registered flags
        t: (multiuse, query) - Returns a string array containing the names of all of the tool contexts registered by this plug-in.
        tr: (query) - Returns a string array containing the names of all of the file translators registered by this plug-in.
        uo: (query) - Returns a boolean that specifies whether or not the plug-in can be safely unloaded.  It will return false if the plug-in is currently in use.  For example, if the plug-in adds a new dependency node type, and an instance of that node type is present in the scene, then this query will return false.
        u: (query) - Returns a boolean specifying whether or not the plug-in has been assigned a name by the user.
        vd: (query) - Returns a string containing the vendor of the plug-in.
        v: (query) - Returns a string containing the version the plug-in.
...
def preloadRefEd(*args, ctl: bool = ..., dt: Optional[Union[str, bool]] = ..., dtg: Optional[Union[str, bool]] = ..., ex: bool = ..., f: Optional[Union[str, bool]] = ..., fmc: Optional[Union[str, bool]] = ..., hlc: Optional[Union[str, bool]] = ..., lck: bool = ..., mlc: Optional[Union[str, bool]] = ..., pnl: Optional[Union[str, bool]] = ..., p: Optional[Union[str, bool]] = ..., sc: Optional[Union[str, bool]] = ..., sf: bool = ..., slc: Optional[Union[str, bool]] = ..., sts: bool = ..., up: bool = ..., ulk: bool = ..., upd: bool = ..., ut: Optional[Union[str, bool]] = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ...
        pnl: (create, query) - Specifies the panel for this editor. By default if an editor is created in the create callback of a scripted panel it will belong to that panel. If an editor does not belong to a panel it will be deleted when the window that it is in is deleted.
        p: (create, edit, query) - Specifies the parent layout for this editor. This flag will only have an effect if the editor is currently un-parented.
        sc: (create, edit, query) - A script to be executed when an item is selected.
        sf: (query) - Query the currently selected load setting. Returns the id of the currently selected load setting. This id can be used as an argument to the selLoadSettings command.
        slc: (create, edit, query) - Specifies the name of a selectionConnection object that the editor will synchronize with its own selection list. As the user selects things in this editor, they will be selected in the selectionConnection object. If the object undergoes changes, the editor updates to show the changes.
        sts: (query) - Query only flag. Returns the MEL command that will create an editor to match the current editor state. The returned command string uses the string variable $editorName in place of a specific name.
        up: (create, edit) - Specifies that the editor should be removed from its layout. This cannot be used in query mode.
        ulk: (create, edit) - Unlocks the mainConnection, effectively restoring the original mainConnection (if it is still available), and dynamic updates.
...
def profiler(*args, a: Optional[Union[str, bool]] = ..., ac: bool = ..., b: Optional[Union[int, bool]] = ..., ci: Optional[Union[int, bool]] = ..., cin: Optional[Union[int, bool]] = ..., cf: Optional[Union[str, bool]] = ..., cn: Optional[Union[str, bool]] = ..., cni: Optional[Union[str, bool]] = ..., cr: bool = ..., cam: bool = ..., coi: Optional[Union[int, bool]] = ..., eci: bool = ..., eca: bool = ..., eco: bool = ..., ec: bool = ..., ed: bool = ..., edu: bool = ..., ei: Optional[Union[int, bool]] = ..., en: bool = ..., et: bool = ..., eti: bool = ..., instrumentMel: bool = ..., l: Optional[Union[str, bool]] = ..., o: Optional[Union[str, bool]] = ..., pd: Optional[Union[str, bool]] = ..., pn: Optional[Union[str, bool]] = ..., rc: Optional[Union[str, bool]] = ..., r: bool = ..., s: bool = ..., sig: bool = ..., sim: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        a: (create) - Add a new category for the profiler. Returns the index of the new category.
        ac: (query) - Query the names of all categories. If the categoryInfo flag is set then alternate the name of the category with the description of the category.
        b: (create, query) - Toggled : change the buffer size to fit the specified number of events (requires that sampling is off) Query : return the current buffer size The new buffer size will only take effect when next sampling starts. When the buffer is full, the recording stops.
        ci: (create, query) - Used in conjunction with other flags, to indicate the index of the category. 			In query mode, this flag needs a value.
        cin: (create, query) - Returns the name of the category with a given index. 			In query mode, this flag needs a value.
        cf: (create, query) - When used with the addCategory flag set the description of the added profiler category. In query mode return the description of the category referenced by either the categoryIndex or categoryName flags. 			In query mode, this flag can accept a value.
        cn: (query) - Used in conjunction with other flags, to indicate the name of the category. 			In query mode, this flag needs a value.
        cni: (create, query) - Returns the index of the category with a given name. 			In query mode, this flag needs a value.
        cr: (create, query) - Toggled : Enable/disable the recording of the category. Query : return if the recording of the category is On. Requires the -categoryIndex or -categoryName flag to specify the category to be queried.
        cam: (create) - Clear all MEL command or procedure instrumentation.
        coi: (create) - Used with "-instrumentMel true" to specify the color index to show the profiling result.
        eci: (query) - Query the CPU ID of the event at the given index. Requires the -eventIndex flag to specify the event to be queried.
        eca: (query) - Query the category index the event at the given index belongs to. Requires the -eventIndex flag to specify the event to be queried.
        eco: (query) - Query the color of the event at the given index. Requires the -eventIndex flag to specify the event to be queried.
        ec: (query) - Query the number of events in the buffer
        ed: (query) - Query the description of the event at the given index. Requires the -eventIndex flag to specify the event to be queried.
        edu: (query) - Query the duration of the event at the given index, the time unit is microsecond. Note that a signal event has a 0 duration. Requires the -eventIndex flag to specify the event to be queried.
        ei: (query) - Used usually in conjunction with other flags, to indicate the index of the event. 			In query mode, this flag needs a value.
        en: (query) - Query the name of the event at the given index. Requires the -eventIndex flag to specify the event to be queried.
        et: (query) - Query the time of the event at the given index, the time unit is microsecond. Requires the -eventIndex flag to specify the event to be queried.
        eti: (query) - Query the thread ID of the event at the given index. Requires the -eventIndex flag to specify the event to be queried.
        ...
        l: (create, query) - Read the recorded events from the specified file
        o: (create, query) - Output the recorded events to the specified file
        pd: (create) - Used with "-instrumentMel true" to provide a description of the MEL command or procedure being instrumented. This description can be viewed in the Profiler Tool window.
        pn: (create) - Used with -instrumentMel to specify the name of the procedure to be enabled/disabled the instrumentation.
        rc: (create) - Remove an existing category for the profiler. Returns the index of the removed category.
        r: (create, query) - reset the profiler's data (requires that sampling is off)
        s: (create, query) - Toggled : Enable/disable the recording of events Query : return if the recording of events is On.
        ...
        sim: (create) - Used with "-instrumentMel true", inform profiler that this instrumented MEL command or procedure will be taken as a signal event during profiling. A Signal Event only remembers the start moment and has no knowledge about duration. It can be used in cases when the user does not care about the duration but only cares if this event does happen.
    """
    ...


def profilerTool(*args, cat: bool = ..., cs: bool = ..., csr: bool = ..., cpu: bool = ..., dtr: bool = ..., et: bool = ..., ex: bool = ..., es: bool = ..., esr: bool = ..., fn: bool = ..., fp: bool = ..., fa: bool = ..., fs: bool = ..., isolateSegment: int = ..., mk: bool = ..., mww: bool = ..., se: Optional[Union[str, bool]] = ..., sc: bool = ..., sa: bool = ..., scp: bool = ..., sh: bool = ..., ss: bool = ..., ssr: bool = ..., thd: bool = ..., uis: bool = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        cat: (edit) - Change view mode to category view
        cs: (edit) - Hide all sub-events of selected events so that only top-level events show
        csr: (edit) - Hide all sub-events repetition of selected events based on their comment
        cpu: (edit) - Change view mode to cpu view
        dtr: (create) - Destroy the profiler tool Internal flag. Should not be used by user.
        et: (query) - Return JSON data containing the list of event types on currently existing events. If the value of the flag is true then show only event types for selected events, otherwise show them for all events.  The JSON return string will contain the event type information in the following format:  {     "eventSummary" : [         { "type"        : EVENT_TYPE_NAME,         , "description" : EVENT_TYPE_DESCRIPTION,         , "color"       : [ RED_AS_FLOAT, GREEN_AS_FLOAT, BLUE_AS_FLOAT ]         , "category"    : CATEGORY_NAME         , "count"       : EVENT_TYPE_COUNT         }     ] }  "type" and "description" may be omitted, indicating that the results correspond to anonymous events.
        ex: (query) - Query if the profiler tool view exists. Profiler tool can only exist after "profilerTool -make" is called.
        es: (edit) - Show all sub-events of selected events
        esr: (edit) - Show all sub-events repetition of selected events based on their comment
        fn: (query) - This flag is used along with flag -searchEvent.
        fp: (query) - This flag is used along with flag -searchEvent.
        fa: (edit) - Frame on all events in the profilerToolView
        fs: (edit) - Frame on all selected events in the profilerToolView
        ...
        mk: (create) - Make the profiler tool and parent it to the most recent layout created Internal flag. Should not be used by user.
        mww: (edit) - Tells profiler tool if it should match whole word when searching event(s). The default value is false.
        se: (query) - Search event(s). You can set -matchWholeWord before you use -searchEvent. If -matchWholeWord has been set to true, the profiler tool will search event(s) whose name exactly matches with the string. If -matchWholeWord has been set to false, the profiler tool will search event(s) whose name contains the string. If -findNext is also used along with this flag, the profiler tool will find the first event next to the current selected event. If -findPrevious is also used along with this flag, the profiler tool will find the first event previous to the current selected event. If currently don't have a selected event or there are multiple selected events, the search will start at the first event in profiler buffer. If -findNext and -findPrevious are not used along with this flag, the profiler tool will find all events. 			In query mode, this flag needs a value.
        sc: (query) - Returns the number of segments in the event buffer.
        sa: (edit) - Show all events (if events were hidden by filtering) (true) or Hide all events (false)
        scp: (edit) - Show critical path of selected frame
        sh: (edit) - Show hotspot of selected frame
        ss: (edit) - Show only the selected events (true) or hide all selected events (false)
        ssr: (edit) - Show only the selected events repetition based on their comment (true) or Hide all selected events repetition based on their comment (false)
        thd: (edit) - Change view mode to thread view
        uis: (edit) - Unisolate current isolated segment. If no segment is currently isolated, nothing will happen.
    """
    ...


def recordAttr(*args, at: Optional[Union[str, bool]] = ..., d: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        at: (create, multiuse) - specify the attribute to record
        d: (create) - Do not record the specified attributes
    """
    ...
...
def referenceEdit(*args, afe: bool = ..., cet: Optional[Union[Tuple[str, str], bool]] = ..., fld: bool = ..., r: bool = ..., scs: bool = ..., ec: Optional[Union[str, bool]] = ..., orn: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        afe: (create) - Attempts to apply any unapplied edits. This flag is useful if previously failing edits have been fixed using the -changeEditTarget flag. This flag can only be used on loaded references. If the command target is a referenced node, the associated reference is used instead.
        ...
        fld: (create) - This is a secondary flag used to indicate whether or not failed edits should be acted on (e.g. queried, removed, etc...). A failed edit is an edit which could not be successfully applied the last time its reference was loaded. An edit can fail for a variety of reasons (e.g. the referenced node to which it applies was removed from the referenced file). By default failed edits will be acted on.
        r: (create) - Remove edits which affect the specified unloaded commandTarget.
        scs: (create) - This is a secondary flag used to indicate whether or not successful edits should be acted on (e.g. queried, removed, etc...). A successful edit is any edit which was successfully applied the last time its reference was loaded. This flag will have no affect if the commandTarget is loaded. By default successful edits will not be acted on.
        ec: (create, multiuse, query) - This is a secondary flag used to indicate which type of reference edits should be considered by the command. If this flag is not specified all edit types will be included. This flag requires a string parameter. Valid values are: "addAttr", "connectAttr", "deleteAttr", "disconnectAttr", "parent", "setAttr", "lock" and "unlock". In some contexts, this flag may be specified more than once to specify multiple edit types to consider.
        orn: (create, multiuse, query) - This is a secondary flag used to indicate that only those edits which are stored on the indicated reference node should be considered. This flag only supports multiple uses when specified with the "exportEdits" command.
    """
    ...
...
def referenceQuery(*args, ch: bool = ..., iee: bool = ..., il: bool = ..., le: bool = ..., dp: bool = ..., ea: bool = ..., en: bool = ..., es: bool = ..., fld: bool = ..., f: bool = ..., inr: bool = ..., ipo: bool = ..., ns: bool = ..., n: bool = ..., p: bool = ..., pns: bool = ..., rfn: bool = ..., shn: bool = ..., sdp: bool = ..., sfp: bool = ..., sns: bool = ..., scs: bool = ..., tr: bool = ..., un: bool = ..., wcn: bool = ..., ec: Optional[Union[str, bool]] = ..., orn: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        ch: (create) - This flag modifies the '-rfn/-referenceNode' and '-f/-filename' flags to indicate the the children of the target reference will be returned. Returns a string array.
        iee: (create) - Returns a boolean indicating whether the specified reference node or file name is an edits file (created with the Export Edits feature)
        il: (create) - Returns a boolean indicating whether the specified reference node or file name refers to a loaded or unloaded reference.
        le: (create) - Specifies that the edits should be returned based on the live edits database. Only valid when used in conjunction with the editStrings flag.
        dp: (create) - This flag modifies the '-n/-nodes' flag to indicate that the names of any dag objects returned will include as much of the dag path as is necessary to make the names unique. If this flag is not present, the names returned will not include any dag paths.
        ea: (create) - Returns string array. A main flag used to query the edits that have been applied to the target. Only the names of the attributes involved in the reference edit will be returned. If an edit involves multiple attributes (e.g. "connectAttr" edits) the nodes will be returned as separate, consecutive entries in the string array. A valid target is either a reference node, a reference file, or a referenced node. If a referenced node is specified, only those edits which affect that node will be returned. If a reference file or reference node is specified any edit which affects a node in that reference will be returned. If no target is specified all edits are returned. This command can be used on both loaded and unloaded references. By default it will return all the edits, formatted as MEL commands, which apply to the target. This flag can be used in combination with the '-ea/-editAttrs' flag to indicate that the names of both the involved nodes and attributes will be returned in the format 'node.attribute'.
        en: (create) - Returns string array. A main flag used to query the edits that have been applied to the target. Only the names of the nodes involved in the reference edit will be returned. If an edit involves multiple nodes (e.g. "connectAttr" edits) the nodes will be returned as separate, consecutive entries in the string array. A valid target is either a reference node, a reference file, or a referenced node. If a referenced node is specified, only those edits which affect that node will be returned. If a reference file or reference node is specified any edit which affects a node in that reference will be returned. If no target is specified all edits are returned. This command can be used on both loaded and unloaded references. By default it will return all the edits, formatted as MEL commands, which apply to the target. This flag can be used in combination with the '-ea/-editAttrs' flag to indicate that the names of both the involved nodes and attributes will be returned in the format 'node.attribute'.
        es: (create) - Returns string array. A main flag used to query the edits that have been applied to the target. The edit will be returned as a valid MEL command. A valid target is either a reference node, a reference file, or a referenced node. If a referenced node is specified, only those edits which affect that node will be returned. If a reference file or reference node is specified any edit which affects a node in that reference will be returned. If no target is specified all edits are returned. This command can be used on both loaded and unloaded references. By default it will return all the edits, formatted as MEL commands, which apply to the target. This flag cannot be used with either the '-en/-editNodes' or '-ea/-editAttrs' flags.
        ...
        f: (create) - Returns string. A main flag used to query the filename associated with the target reference.
        inr: (create) - Returns boolean. A main flag used to determine whether or not the target node comes from a referenced file. true if the target node comes from a referenced file, false if not.
        ipo: (create) - Returns boolean. This flag is used to determine whether or not the target reference node is only a preview reference node.
        ns: (create) - Returns string. This flag returns the full namespace path of the target reference, starting from the root namespace ":". It can be combined with the shortName flag to return just the base name of the namespace.
        n: (create) - Returns string array. A main flag used to query the contents of the target reference.
        p: (create) - This flag modifies the '-rfn/-referenceNode' and '-f/-filename' flags to indicate the the parent of the target reference will be returned.
        pns: (create) - A main flag used to query and return the parent namespace of the target reference.
        rfn: (create) - Returns string. A main flag used to query the reference node associated with the target reference.
        ...
        sdp: (create) - Shows/hides the full dag path for edits. If false only displays the node-name of reference edits. Must be used with the -editNodes, -editStrings or -editAttrs flag.
        sfp: (create) - Return the full path from the root namespace for reference edits. Must be used with the -editNodes, -editStrings or -editAttrs flags.
        sns: (create) - Shows/hides the namespaces on nodes in the reference edits. Must be used with the -editNodes, -editStrings or -editAttrs flag
        scs: (create) - This is a secondary flag used to indicate whether or not successful edits should be acted on (e.g. queried, removed, etc...). A successful edit is any edit which was successfully applied the last time its reference was loaded. By default successful edits will be acted on.
        tr: (create) - This flag modifies the '-rfn/-referenceNode' flag to indicate the top level ancestral reference of the target reference will be returned.
        un: (create) - This flag modifies the '-f/-filename' flag to indicate that the file name returned will be unresolved (i.e. it will be the path originally specified when the file was loaded into Maya; this path may contain environment variables and may not exist on disk). If this flag is not present, the resolved name will     be returned.
        wcn: (create) - This flag modifies the '-f/-filename' flag to indicate that the file name returned will not have a copy number (e.g. '{1}') appended to the end. If this flag is not present, the file name returned may have a copy number appended to the end.
        ec: (create, multiuse, query) - This is a secondary flag used to indicate which type of reference edits should be considered by the command. If this flag is not specified all edit types will be included. This flag requires a string parameter. Valid values are: "addAttr", "connectAttr", "deleteAttr", "disconnectAttr", "parent", "setAttr", "lock" and "unlock". In some contexts, this flag may be specified more than once to specify multiple edit types to consider.
        orn: (create, multiuse, query) - This is a secondary flag used to indicate that only those edits which are stored on the indicated reference node should be considered. This flag only supports multiple uses when specified with the "exportEdits" command.
    """
    ...
...
def requires(*args, dt: Optional[Union[str, bool]] = ..., nt: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        dt: (create, multiuse) - Specify a data type defined by this plug-in. The data type is specified by MFnPlugin::registerData() when register the plug-in.
        nt: (create, multiuse) - Specify a node type defined by this plug-in. The node type is specified by MFnPlugin::registerNode() when register the plug-in.
    """
    ...


def saveImage(*args, ann: Optional[Union[str, bool]] = ..., bgc: Optional[Union[Tuple[float, float, float], bool]] = ..., cv: bool = ..., dt: Optional[Union[str, bool]] = ..., dtg: Optional[Union[str, bool]] = ..., dgc: Optional[Union[str, bool]] = ..., dpc: Optional[Union[str, bool]] = ..., en: bool = ..., ebg: bool = ..., ekf: bool = ..., ex: bool = ..., fpn: bool = ..., h: Optional[Union[int, bool]] = ..., hlc: Optional[Union[Tuple[float, float, float], bool]] = ..., i: Optional[Union[str, bool]] = ..., io: bool = ..., m: bool = ..., nbg: bool = ..., npm: bool = ..., ot: str = ..., p: Optional[Union[str, bool]] = ..., pma: bool = ..., po: bool = ..., sf: str = ..., sbm: Optional[Union[str, bool]] = ..., ut: Optional[Union[str, bool]] = ..., vis: bool = ..., vcc: Optional[Union[str, bool]] = ..., w: Optional[Union[int, bool]] = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ...
        cv: (edit) - Generate the image from the current view.
        dt: (create) - Puts the command in a mode where any other flags and arguments are parsed and added to the command template specified in the argument. They will be used as default arguments in any subsequent invocations of the command when templateName is set as the current template.
        ...
        ot: (edit) - Use an image of the named object, if possible.
        ...
        sf: (edit) - The name of the file that the icon is to be associated with.
...
def sceneEditor(*args, ctl: bool = ..., dt: Optional[Union[str, bool]] = ..., dtg: Optional[Union[str, bool]] = ..., ex: bool = ..., f: Optional[Union[str, bool]] = ..., fmc: Optional[Union[str, bool]] = ..., hlc: Optional[Union[str, bool]] = ..., lck: bool = ..., mlc: Optional[Union[str, bool]] = ..., op: bool = ..., pnl: Optional[Union[str, bool]] = ..., p: Optional[Union[str, bool]] = ..., rr: bool = ..., sc: Optional[Union[str, bool]] = ..., si: Optional[Union[int, bool]] = ..., sr: Optional[Union[str, bool]] = ..., slc: Optional[Union[str, bool]] = ..., shn: bool = ..., sts: bool = ..., up: bool = ..., ulk: bool = ..., un: bool = ..., upd: bool = ..., ut: Optional[Union[str, bool]] = ..., wcn: bool = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ...
        lck: (create, edit) - Locks the current list of objects within the mainConnection, so that only those objects are displayed within the editor. Further changes to the original mainConnection are ignored.
        mlc: (create, edit, query) - Specifies the name of a selectionConnection object that the editor will use as its source of content. The editor will only display items contained in the selectionConnection object.
        op: (query) - When used with the 'selectItem' or 'selectReference' queries it indicates that, if both a parent and a child file or reference are selected, only the parent will be returned.
        pnl: (create, query) - Specifies the panel for this editor. By default if an editor is created in the create callback of a scripted panel it will belong to that panel. If an editor does not belong to a panel it will be deleted when the window that it is in is deleted.
        p: (create, edit, query) - Specifies the parent layout for this editor. This flag will only have an effect if the editor is currently un-parented.
        rr: (edit) - Force refresh of references
        sc: (create, edit, query) - A script to be executed when an item is selected.
        si: (edit, query) - Query or change the currently selected item. When queried, the currently selected file name will be return.
        sr: (query) - Query the currently selected reference. Returns the name of the currently selected reference node.
        slc: (create, edit, query) - Specifies the name of a selectionConnection object that the editor will synchronize with its own selection list. As the user selects things in this editor, they will be selected in the selectionConnection object. If the object undergoes changes, the editor updates to show the changes.
        shn: (query) - When used with the 'selectItem' query it indicates that the file name returned will be the short name (i.e. just a file name without any directory paths). If this flag is not present, the full name and directory path will be returned.
        sts: (query) - Query only flag. Returns the MEL command that will create an editor to match the current editor state. The returned command string uses the string variable $editorName in place of a specific name.
        up: (create, edit) - Specifies that the editor should be removed from its layout. This cannot be used in query mode.
        ulk: (create, edit) - Unlocks the mainConnection, effectively restoring the original mainConnection (if it is still available), and dynamic updates.
        un: (query) - When used with the 'selectItem' query it indicates that the file name returned will be unresolved (i.e. it will be the path originally specified when the file was loaded into Maya; this path may contain environment variables and may not exist on disk). If this flag is not present, the resolved name will    be returned.
        upd: (create, edit) - Causes a locked mainConnection to be updated from the orginal mainConnection, but preserves the lock state.
        ut: (create) - Forces the command to use a command template other than the current one.
        wcn: (query) - When used with the 'selectItem' query it indicates that the file name returned will not have a copy number appended to the end. If this flag is not present, the file name returned may have a copy number appended to the end.
    """
    ...


def sceneUIReplacement(*args, cl: bool = ..., dr: bool = ..., gf: Optional[Union[Tuple[str, str], bool]] = ..., gp: Optional[Union[Tuple[str, str], bool]] = ..., gsp: Optional[Union[Tuple[str, str], bool]] = ..., u: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        cl: (create) - Frees any resources allocated by the command.
        dr: (create) - Delete any UI that is scene dependent and has not been referenced by this command since the last update.
        gf: (create) - Returns the next filter of the specified type with the specified name.
        gp: (create) - Returns the next panel of the specified type, preferably with the specified label.
        gsp: (create) - Returns the next scripted panel of the specified scripted panel type, preferably with the specified label.
        u: (create) - Updates the state of the command to reflect the current state of the application.  The string argument is the name of the main window pane layout holding the panels.
    """
    ...


def scriptNode(*args, afterScript: Optional[Union[str, bool]] = ..., bs: Optional[Union[str, bool]] = ..., ea: bool = ..., eb: bool = ..., ire: bool = ..., n: Optional[Union[str, bool]] = ..., st: Optional[Union[int, bool]] = ..., stp: Optional[Union[str, bool]] = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ...
        bs: (create, edit, query) - The script executed during file load.  C: The default is an empty string.  Q: When queried, this flag returns a string.
        ea: (create) - Execute the script stored in the .after attribute of the scriptNode. This script is normally executed when the script node is deleted.
        eb: (create) - Execute the script stored in the .before attribute of the scriptNode. This script is normally executed when the file is loaded.
        ire: (create) - Sets whether changes made to referenced nodes during the execution of the script should be recorded as reference edits. This flag must be set when the scriptNode is created. If this flag is not set, changes to referenced nodes will be recorded as edits by default.
        n: (create) - When creating a new scriptNode, this flag specifies the name of the node. If a non-unique name is used, the name will be modified to ensure uniqueness.
        ...
        stp: (create, edit, query) - Sets the language type for both the attached scripts. Valid values are "mel" (enabled by default), and "python".
    """
    ...


def selLoadSettings(*args, ap: Optional[Union[str, bool]] = ..., dr: bool = ..., fn: Optional[Union[str, bool]] = ..., ns: Optional[Union[int, bool]] = ..., pm: Optional[Union[str, bool]] = ..., psf: Optional[Union[str, bool]] = ..., pst: Optional[Union[str, bool]] = ..., pt: Optional[Union[str, bool]] = ..., rfn: Optional[Union[str, bool]] = ..., shn: bool = ..., un: bool = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        ap: (create, edit, query) - Change or query the active proxy of a proxy set. In query mode, returns the proxyTag of the active proxy; in edit mode, finds the proxy in the proxySet with the given tag and makes it the active proxy.
        dr: (create, edit, query) - Change or query the load state of a reference.
        fn: (create, query) - Return the file name reference file(s) associated with the indicated load setting(s).
        ns: (create, query) - Return the number of settings in the group of implicit load settings. This is equivalent to number of references in the scene plus 1.
        pm: (create, query) - Return the name(s) of the proxy manager(s) associated with the indicated load setting(s).
        psf: (create, query) - Return the name(s) of the proxy(ies) available in the proxy set associated with the indicated load setting(s).
        pst: (create, query) - Return the name(s) of the proxy tag(s) available in the proxy set associated with the indicated load setting(s).
        pt: (create, query) - Return the name(s) of the proxy tag(s) associated with the indicated load setting(s).
        rfn: (create, query) - Return the name(s) of the reference node(s) associated with the indicated load setting(s).
        shn: (create, query) - Formats the return value of the 'fileName' query flag to only return the short name(s) of the reference file(s).
        un: (create, query) - Formats the return value of the 'fileName' query flag to return the unresolved name(s) of the reference file(s). The unresolved file name is the file name used when the reference was created, whether or not that file actually exists on disk. When Maya encounters a file name which does not exist on disk it attempts to resolve the name by looking for the file in a number of other locations. By default the 'fileName' flag will return this resolved value.
    """
    ...


def setAttrMapping(*args, a: bool = ..., at: Optional[Union[str, bool]] = ..., ax: Optional[Union[str, bool]] = ..., c: Optional[Union[str, bool]] = ..., d: Optional[Union[str, bool]] = ..., o: Optional[Union[float, bool]] = ..., r: bool = ..., s: Optional[Union[float, bool]] = ..., sl: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        a: (create) - Make the mapping absolute.
        at: (create, multiuse) - The attribute used in the attachment.
        ax: (create) - The axis on the device used in the attachment.
        c: (create) - The clutch button used in the attachment.
        d: (create) - The device used in the attachment.
        o: (create) - Specify the offset value.
        r: (create) - Make the mapping relative.
        s: (create) - Specify the scale value.
        sl: (create) - This flag specifies the mapping should be on the selected objects
    """
    ...


def setInputDeviceMapping(*args, a: bool = ..., ax: Optional[Union[str, bool]] = ..., d: Optional[Union[str, bool]] = ..., o: Optional[Union[float, bool]] = ..., r: bool = ..., s: Optional[Union[float, bool]] = ..., v: bool = ..., w: bool = ...) -> Any:
    r"""
    ...
    Args:
        a: (create) - report absolute axis values
        ax: (create, multiuse) - specify the axis to map
        d: (create) - specify which device to map
        o: (create) - specify the axis offset value
        r: (create) - report the change in axis value since the last sample
        s: (create) - specify the axis scale value
        v: (create) - translate the device coordinates into the coordinates of the active camera
        w: (create) - translate the device coordinates into world space coordinates
    """
    ...


def shotTrack(*args, it: Optional[Union[int, bool]] = ..., l: bool = ..., m: bool = ..., nt: Optional[Union[int, bool]] = ..., ret: bool = ..., rt: Optional[Union[int, bool]] = ..., sm: bool = ..., so: bool = ..., st: Optional[Union[Tuple[int, int], bool]] = ..., t: Optional[Union[str, bool]] = ..., tr: Optional[Union[int, bool]] = ..., uso: bool = ..., edit: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        it: (create) - This flag is used to insert a new empty track at the track index specified.
        l: (create, edit, query) - This flag specifies whether shots on a track are to be locked or not.
        m: (create, edit, query) - This flag specifies whether shots on a track are to be muted or not.
        nt: (query) - To query the number of tracks
        ret: (create) - This flag is used to remove all tracks that have no clips.
        rt: (create) - This flag is used to remove the track with the specified index.  The track must have no clips on it before it can be removed.
        sm: (create, edit, query) - This flag specifies whether shots on a track are to be muted or not (unlike mute, this disregards soloing).
        so: (create, edit, query) - This flag specifies whether shots on a track are to be soloed or not.
        st: (create) - This flag is used to swap the contents of two specified tracks.
        t: (create, edit, query) - This flag specifies the title for the track.
        tr: (create, edit, query) - Specify the track on which to operate by using the track's trackNumber. 			In query mode, this flag needs a value.
        uso: (query) - This flag specifies whether shots on a track are to be unsoloed or not.
    """
    ...


def showHelp(*args, a: bool = ..., d: bool = ..., ht: bool = ..., v: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        a: (create) - The specified "URL" is an absolute URL that should be passed directly to the web browser.
        d: (create, query) - Use this flag to directly specify a help file relative to the on-line documentation root.
        ht: (create, query) - Use this flag to specify which file will be used to search for help topics when the -d/docs and -a/absolute flags are not used. If only a file name is specified and not a path, then the file is assumed to be in the maya application directory. If this flag does not accept an argument if it is queried. The default value is "helpTable".
        v: (query) - Use this flag to get the Maya version that the showHelp command uses.
    """
    ...


def sysFile(*args, cp: Optional[Union[str, bool]] = ..., delete: bool = ..., md: bool = ..., mov: Optional[Union[str, bool]] = ..., red: bool = ..., ren: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    This command provides a system independent way to create a directory
    or to rename or delete a file.

    Args:
        cp: (create) - Copy the file to the name given by the newFileName paramter.
        delete: (create) - Deletes the file.
        md: (create) - Create the directory path given in the parameter. This will create the entire path if more than one directory needs to be created.
        mov: (create) - Behaves identically to the -rename flag and remains for compatibility with old scripts
        red: (create) - Delete the directory path given in the parameter if the directory is empty. The command will not delete a directory which is not empty.
        ren: (create) - Rename the file to the name given by the newFileName parameter.
    """
    ...


def timer(*args, e: bool = ..., lap: bool = ..., n: Optional[Union[str, bool]] = ..., s: bool = ...) -> Any:
    r"""
    ...
    Args:
        e: (create) - Stop the timer and return the time elapsed since the timer was started (in seconds). Once a timer is turned off it no longer exists, though it can be recreated with a new start
        lap: (create) - Get the lap time of the timer (time elapsed since start in seconds). Unlike the end flag this keeps the timer running.
        n: (create) - Use a named timer for the operation. If this is omitted then the default timer is assumed.
        s: (create) - Start the timer.
    """
    ...


def timerX(*args, st: Optional[Union[float, bool]] = ...) -> Any:
    r"""
    ...
    Args:
        st: (create) - When this flag is used, the command returns the elapsed time since the specified start time.
    """
    ...


def translator(*args, dfr: bool = ..., do: Optional[Union[str, bool]] = ..., ext: bool = ..., cmp: Optional[Union[str, bool]] = ..., f: bool = ..., l: bool = ..., ld: bool = ..., ot: bool = ..., os: bool = ..., rs: bool = ..., ws: bool = ..., query: bool = ...) -> Any:
    r"""
    Set or query parameters associated with the file translators specified
    in as the argument.

    Args:
        dfr: (query) - Returns the default file rule value, can return "" as well
        do: (query) - Return/set a string of default options used by this translator.
        ext: (query) - Returns the default file extension for this translator.
        cmp: (query) - Specifies the compression action to take when a file is saved. Possible values are "compressed", "uncompressed" "asCompressed".
        f: (query) - Returns the filter string used for this translator.
        l: (query) - Return a string array of all the translators that are loaded.
        ld: (query) - Returns true if the given translator is currently loaded.
        ot: (query) - This flag is obsolete. This will now return the same results as defaultFileRule going forward.
        ...
        rs: (query) - Returns true if this translator supports read operations.
        ws: (query) - Returns true if this translator supports write operations.
    """
    ...


def unassignInputDevice(*args, c: Optional[Union[str, bool]] = ..., d: Optional[Union[str, bool]] = ..., query: bool = ...) -> Any:
    r"""
    This command deletes all command strings associated with this
    device.

    Args:
        c: (create) - Only delete command attachments with this clutch.
        d: (create) - Specifies the device to work on.
    """
    ...
...
def undoInfo(*args, cn: Optional[Union[str, bool]] = ..., cck: bool = ..., infinity: bool = ..., l: Optional[Union[int, bool]] = ..., ock: bool = ..., pq: bool = ..., prq: bool = ..., rn: Optional[Union[str, bool]] = ..., rqe: bool = ..., st: bool = ..., swf: bool = ..., un: Optional[Union[str, bool]] = ..., uqe: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        cn: (create, query) - Sets the name used to identify a chunk for undo/redo purposes when opening a chunk.
        cck: (create) - Closes the chunk that was opened earlier by openChunk. Once close chunk is called, all undoable operations in the chunk will undo as a single undo operation. Use with CAUTION!! Improper use of this command can leave the undo queue in a bad state.
        infinity: (create, query) - Set the queue length to infinity.
        l: (create, query) - Specifies the maximum number of items in the undo queue. The infinity flag overrides this one.
        ock: (create) - Opens a chunk so that all undoable operations after this call will fall into the newly opened chunk, until close chunk is called. Once close chunk is called, all undoable operations in the chunk will undo as a single undo operation. Use with CAUTION!! Improper use of this command can leave the undo queue in a bad state.
        pq: (query) - Prints to the Script Editor the contents of the undo queue.
        prq: (query) - Prints to the Script Editor the contents of the redo queue.
        rn: (query) - Returns what will be redone (if anything)
        rqe: (query) - Return true if the redo queue is empty. Return false if there is at least one command in the queue to be redone.
        st: (create, query) - Turns undo/redo on or off.
        swf: (create, query) - Turns undo/redo on or off without flushing the queue. Use with CAUTION!! Note that if you  perform destructive operations while stateWithoutFlush is disabled, and you then enable it again, subsequent undo operations that try to go past the  destructive operations may be unstable since undo will not be able to properly reconstruct the former state of the scene.
        un: (query) - Returns what will be undone (if anything)
        uqe: (query) - Return true if the undo queue is empty. Return false if there is at least one command in the queue to be undone.
    """
    ...


def unknownNode(*args, p: bool = ..., rcn: bool = ..., rct: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        p: (query) - In query mode return the name of the plug-in from which the unknown node originated. If no plug-in then the empty string is returned.
        rcn: (query) - Return the real class name of the node.
        rct: (query) - Return the real class IFF tag of the node.
    """
    ...


def unknownPlugin(*args, dt: bool = ..., l: bool = ..., nt: bool = ..., r: bool = ..., v: bool = ..., query: bool = ...) -> Any:
    r"""
    Allows querying of the unknown plug-ins used by the scene,
    and provides a means to remove them.

    Args:
        dt: (query) - Returns the data types associated with the given unknown plug-in. This will always be empty for pre-Maya 2014 files.
        l: (query) - Lists the unknown plug-ins in the scene.
        nt: (query) - Returns the node types associated with the given unknown plug-in. This will always be empty for pre-Maya 2014 files.
        r: (create) - Removes the given unknown plug-in from the scene. For Maya 2014 files and onwards, this will fail if node or data types defined by the plug-in are still in use.
        v: (query) - Returns the version string of the given unknown plug-in.
    """
    ...


def unloadPlugin(*args, ac: Optional[Union[str, bool]] = ..., f: bool = ..., rc: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    Unload plug-ins from Maya. After the successful execution of
    this command, plug-in services will no longer be available.

    Args:
        ac: (create) - Add a procedure to be called just before a plugin is unloaded. The procedure should have one string argument, which will be the plugin's name.
        ...
        rc: (create) - Remove a procedure which was previously added with -addCallback.
    """
    ...


def warning(*args, n: bool = ..., sl: bool = ...) -> Any:
    r"""
    ...
    Args:
        n: (create) - Do not include the context information with the warning message.
        sl: (create) - Obsolete. Will be deleted in the next version of Maya. Use the checkbox in the script editor that enables line number display instead.
    """
    ...


def whatsNewHighlight(*args, hc: Optional[Union[Tuple[float, float, float], bool]] = ..., ho: bool = ..., ssd: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        hc: (create, query) - Set the color of the What's New highlight. The arguments correspond to the red, green, and blue color components. Each color component ranges in value from 0.0 to 1.0.
        ho: (create, query) - Toggle the What's New highlighting feature. When turned on, menu items and buttons introduced in the latest version will be highlighted.
        ssd: (create, query) - Set whether the settings dialog for this feature appears on startup.
    """
    ...


def workspace(*args, act: bool = ..., bw: Optional[Union[str, bool]] = ..., cr: Optional[Union[str, bool]] = ..., dir: Optional[Union[str, bool]] = ..., en: Optional[Union[str, bool]] = ..., fr: Optional[Union[Tuple[str, str], bool]] = ..., fre: Optional[Union[str, bool]] = ..., frl: bool = ..., f: bool = ..., fn: bool = ..., l: bool = ..., lfw: bool = ..., lw: bool = ..., n: bool = ..., ot: Optional[Union[Tuple[str, str], bool]] = ..., ote: Optional[Union[str, bool]] = ..., otl: bool = ..., o: bool = ..., pp: Optional[Union[str, bool]] = ..., rfr: Optional[Union[str, bool]] = ..., rve: Optional[Union[str, bool]] = ..., rt: Optional[Union[Tuple[str, str], bool]] = ..., rte: Optional[Union[str, bool]] = ..., rtl: bool = ..., rd: bool = ..., s: bool = ..., sn: bool = ..., u: bool = ..., ua: bool = ..., v: Optional[Union[Tuple[str, str], bool]] = ..., ve: Optional[Union[str, bool]] = ..., vl: bool = ..., query: bool = ...) -> Any:
    r"""
    ...
    Args:
        act: (create, query) - This flag is a synonym for -o/openWorkspace.
        bw: (query) - A workspace may be based on another workspace.  This means that all the file rules and variables in the base workspace apply to this workspace unless they are explicitly overridden. By default, a new workspace has the workspace "default" as it's base workspace. Note that "duplicated" file rules containing relative paths are not verified nor created when creating a new workspace or when changing the base workspace.
        cr: (create) - Create a new directory.  If the directory name is not a full path name, it will be created as a subdirectory of the "current" directory set with the -dir flag. Note that this flag does not create a workspace.
        dir: (create, query) - This option will set the current workspace directory to the path specified. When queried it will return the current workspace directory. This directory is used as an initial directory for the fileBrowser and is part of the search path used for locating files. It should not be confused with the current working directory as used by the pwd and chdir commands. When the file browser is used, it will set this value to the last location navigated to.
        en: (create, query) - Query for the full path location of a filename using the current workspace definition. The path may be a project relative file name, a full path name or a variable name. The return value is always a full path name. If the path is an empty string, the return value will be the project root directory. Variable expansion is supported, and will consider both variables defined in the workspace as well as environment variables. There are three formats supported for expanding variable names: %variableName%, $variableName, ${variableName}. Maya will first attempt to find matching variables defined in the current workspace, then search for a matching environment variable. The tilde character ('~') is also supported. If a tilde is located at the beginning of a variable, Maya will only consider and expand environment variables, and will leave the tilde in the expanded result. On linux and mac platforms, a tilde can be used to expand a user's home directory, using the form ~username, ~, or ~/.  When specified as ~username, it will be replaced with the corresponding user's home directory.  When specified as ~ or ~/, it will be replaced with the value of the HOME environment variable.
        fr: (create, query) - Set the default location for a file. The first parameter is the fileRule name(scenes, images, etc) and the second is the location. When queried, it returns a list of strings.  The elements of the returned list alternate between fileRule names and the corresponding location.  There is typically one file rule for each available translator. Environment variables are supported. You can set multiple path for the file rule by separating them with semicolons (;) on Windows and colons(:) on MacOSX and Linux. Note that whitespace at the beginning and end of each item in the separated sequence is significant and will be included as part of the path name (which is not usually desired unless the pathname does actually start or end with spaces). A valid filerule name cannot contain multiple byte characters. Note that creating a filerule does not create any directories. It is the user's responsibility to ensure that all paths are valid.
        fre: (create, query) - Return the location for the given fileRule.
        frl: (create, query) - Returns a list of the currently defined file rules.
        f: () - This flag is obsolete.
        fn: (create, query) - Return the full name of the workspace.
        l: (create, query) - This option will list the current workspace directory. If a path is specified for the "workspaceFile" then the contents of that directory will be listed.  Otherwise, the contents of the directory set with the -dir flag will be listed.
        lfw: (create, query) - Returns a list of the full path names of all the currently defined workspaces.
        lw: (create, query) - Returns a list of all the currently defined workspace names.
        n: (create) - This specifies that a new workspace is being created with a given path (full path or relative to "current" directory). If a workspace with this path already exists, the command will fail. Note that the application is creating a virtual workspace without creating any new directories. If given a relative path, it will map the new workspace to the "current" directory set with the -dir flag concatenated with the given path. If the path does not exist, it will default the workspace root directory -rd to the system's root path (e.g. C:\ or '/'). It is the user's responsibility to ensure that all paths exist.
        ot: (create, query) - This flag is obsolete. All default locations will be added to the fileRules going forward.
        ote: (create, query) - This flag is obsolete. This will now return the same as fileRuleEntry.
        otl: (create, query) - This flag is obsolete. This will now return the same results as fileRuleList going forward.
        o: (create, query) - Open the workspace.  The workspace becomes the current workspace.
        pp: (create, query) - Convert filePath passed as argument to a filename that is relative to the project root directory (if possible) and return it.  If the filePath is not under the project root directory, a full path name will be returned.
        rfr: (create) - Remove the given file rule from the specified workspace. If the workspace name is not specified, the given file rule will be removed from the current workspace.
        rve: (create) - Remove the given variable from the specified workspace. If the workspace name is not specified, the given variable will be removed from the current workspace.
        rt: (create, query) - This flag is obsolete. All default render types will be added to fileRules going forward.
        rte: (create, query) - This flag is obsolete, use fileRuleEntry going forward
        rtl: (create, query) - This flag is obsolete, use fileRuleList going forward.
        rd: (query) - Returns the root directory of the workspace.
        s: (create) - Save the workspace.  Workspaces are normally saved when Maya exits but this flag will make sure that the data is flushed to disk.
        sn: (create, query) - Query the short name of the workspace.
        u: (create) - This flag reads all the workspace definitions from the project directory.  It is used by Maya at startup time to find the available workspaces.
        ua: (create) - This flag is a synonym for -u/update.
        v: (create, query) - Set or query the value of a project variable. Project variables are used when expanding names. See the -en/expandName flag below.
        ve: (create, query) - Given a variable name, will return its value.
        vl: (create, query) - Return a list of all variables in the workspace.
    """
    ...


def xpmPicker(*args, fn: Optional[Union[str, bool]] = ..., p: Optional[Union[str, bool]] = ...) -> Any:
    r"""
    Open a dialog and ask you to choose a xpm file

    Args:
        fn: (create) - default filename to display in dialog
        p: (create) - parent window for modal dialog
    """
    ...
